...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(283, 6, 435, 211))
        ...
        self.horizontalLayout_42.addWidget(self.line_13)
        ...
        self.transportAnalyzeWithOE = QtWidgets.QPushButton(self.layoutWidget2)
        self.transportAnalyzeWithOE.setMaximumSize(QtCore.QSize(90, 16777215))
        font = QtGui.QFont()
        font.setFamily(".SF NS Text")
        font.setPointSize(13)
        font.setBold(True)
        self.transportAnalyzeWithOE.setFont(font)
        self.transportAnalyzeWithOE.setObjectName("transportAnalyzeWithOE")
        self.horizontalLayout_19.addWidget(self.transportAnalyzeWithOE)
        ...
        self.transportClearOE = QtWidgets.QPushButton(self.layoutWidget2)
        self.transportClearOE.setEnabled(False)
        font = QtGui.QFont()
        font.setFamily(".SF NS Text")
        font.setPointSize(13)
        font.setBold(True)
        self.transportClearOE.setFont(font)
        self.transportClearOE.setObjectName("transportClearOE")
        self.horizontalLayout_24.addWidget(self.transportClearOE)
...
"aperture placement."))
        ...
        self.transportAnalyze.setToolTip(_translate("MainWindow", "<html><head/><body><p>Extract light curves using aperture photometry (even if an optimal extraction psf has been calculated).</p><p>Advance frame by frame from <span style=\" font-weight:600; color:#fc0107;\">current frame</span> up to (or down to) <span style=\" font-weight:600; color:#fc0107;\">stop frame</span>, tracking and recording aperture data for plots and csv export. That is, generate the light curve data using aperture photometry with binary masks.</p></body></html>"))
        self.transportAnalyze.setText(_translate("MainWindow", "AP analysis"))
        self.transportAnalyzeWithOE.setToolTip(_translate("MainWindow", "<html><head/><body><p>Extract light curves using Noise Reduction Extraction.</p><p><span style=\" font-weight:700; color:#ff0000;\">You must first calculate the noise reduction psf before this function will operate.</span></p><p>Advance frame by frame from <span style=\" font-weight:600; color:#fc0107;\">current frame</span> up to (or down to) <span style=\" font-weight:600; color:#fc0107;\">stop frame</span>, tracking and recording aperture data for plots and csv export. That is, generate the light curve data using Noise Reduction Extraction based on a previously calculated Noise Reduction Extraction psf. </p><p>Weighted masks are used that give more weight to bright pixels, which have lower noise, and less weight to dimmer pixels, which are inherently noisier, resulting in an overall lower noise in the extracted light curves.</p></body></html>"))
        self.transportAnalyzeWithOE.setText(_translate("MainWindow", "NRE analysis"))
        ...
        self.transportTargetPsf.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">To apply Noise Reduction Extraction in PyMovie follow these steps:</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">1) Choose a representative star that is fairly bright but not saturated and place a static mask aperture on this star.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">2) Name this aperture with a string that starts with: </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#0000ff;\">psf-star</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\">3) Set the radius of the circular mask in this aperture to a size that generously encloses the star image. 6.8 has been found to be effective.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\">4) The circular mask radius of ALL other static mask apertures must be the same as that used in </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#0000ff;\">psf-star</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\">5) Place a static mask aperture on the target star using the same circular mask radius used in step 3</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">6) Set the start frame and the stop frame so that several hundred (or so) frames will be utilized in composing the experimental psf.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">7) Click the </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#0000ff;\">calculate Noise Reduction psf</span><span style=\" font-family:\'Arial\',\'sans-serif\';\"> button.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">After the above steps have been performed, you can choose to perform a light curve extraction using \'Noise Reduction Extraction\' by clicking on the </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#0000ff;\">NRE analysis</span><span style=\" font-family:\'Arial\',\'sans-serif\';\"> button. There is no restriction on what frames can be utilized in that analysis run - no need to avoid the frames used in composing the psf.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">If you click instead on the </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#0000ff;\">AP analysis</span><span style=\" font-family:\'Arial\',\'sans-serif\';\"> button, then light curve extraction will use normal aperture photometry, even if a Noise Reduction Extraction psf has been calculated.</span></p><p><span style=\" font-weight:700;\">============ Background =================</span></p><p>Optimal extraction for imaging photometry was introduced by Tim Naylor in his 1998 paper titled: <span style=\" font-weight:700; color:#ff0000;\">An optimal extraction algorithm for imaging photometry. [Mon. Not. R. Astron. Soc. 296, 339-346 (1998)]</span><span style=\" color:#000000;\">.</span></p><p><span style=\" color:#000000;\">Naylor\'s algorithm utilizes a two-dimensional gaussian as an approximation to the psf of stars in the image and demonstrates that this is an effective approximation in practice. Using this analytic psf, the paper describes how to calculate a weighted mask that lowers the noise in a star intensity measurement by giving a larger weight to those pixel that have a higher SNR and a lower weight to dimmer, noisier pixels - </span><span style=\" font-weight:700; color:#000000;\">this is the core idea in all optimal extraction schemes</span><span style=\" color:#000000;\">.</span></p><p>PyMovie uses a version of Optimal Extraction inspired by an observation made by V. Marchiori in the paper: <span style=\" font-weight:700; color:#ff0000;\">In-Flight photometry extraction of PLATO targets, Optimal apertures for detecting extrasolar planets. [arXiv:1906.00892v1 (Astro-ph.IM) 3 Jun 2019]</span>.</p><p><br/><span style=\" font-family:\'Arial\',\'sans-serif\';\">That paper (in section 4.6.1 Gradient mask) develops an equation for computing the optimal weights for the pixels in a star image that has an arbitrary psf, not necessarily gaussian or symmetric. The inspirational (for me) observation was made a little later in the paper: it says that the weights calculated by their equation resemble very closely the weights from a gaussian mask and they go on to show that the results obtained using the gaussian mask were nearly as good as those obtained by using the mathematically correct weights of a gradient mask. Noting that the psf of the star recorded by PLATO optics is a gaussian, PyMovie takes that idea to an extreme and uses the </span><span style=\" font-family:\'Arial\',\'sans-serif\'; text-decoration: underline;\">measured</span><span style=\" font-family:\'Arial\',\'sans-serif\';\"> psf of a star in the image field as the basis of the weights to be used for optimal extraction. That is, PyMovie assumes no psf model other than that derived from the video recording itself.</span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-size:12pt;\"><br/><br/></span><span style=\" font-family:\'Arial\',\'sans-serif\';\">In short: the psf of a selected star is measured by adding the pixel values from a sequence of frames centered by the nThBrightPixel algorithm described below. Appropriately normalized, this psf is the basis for the weights that are subsequently used in light curve extraction. This has proven to be both robust and usable even for occultations where the target completely disappears.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#ff0000;\">nThBrightPixel cenroid algorithm: </span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">The nThBrightPixel algorithm was conceived and tested by A. G. Basden (reported in </span><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#ff0000;\">Centroids using Brightest Pixel Algorithm by A. G. Basden, et al, MNRAS, 2011</span><span style=\" font-family:\'Arial\',\'sans-serif\';\">). </span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">It operates by finding the n brightest pixels in a masked image, setting all other pixel values to zero, and calculating the x,y centroid of the remaining ‘mass’ (i.e., the pixels values are used in the calculation) - and using that as the center of the image.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#ff0000;\">Note:</span></p><p>Both of the referenced papers develop an equation for weights that are mathematically optimum, given the model that they use. Because the procedure used by PyMovie does not have a mathematical underpinning for the weights used that come from an optimization calculation, it can\'t/shouldn\'t be called Optimal Extraction. Instead, we use the term Noise Reduction Extraction. </p><p>Its efficacy has been proven by testing, not by mathematics.<br/></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; font-size:12pt;\"><br/><br/></span></p></body></html>"))
        self.transportTargetPsf.setText(_translate("MainWindow", "calculate Noise Reduction psf"))
        self.transportClearOE.setToolTip(_translate("MainWindow", "<html><head/><body><p>This deletes the experimentally determined psf.</p></body></html>"))
        self.transportClearOE.setText(_translate("MainWindow", "clear Noise Reduction psf"))
