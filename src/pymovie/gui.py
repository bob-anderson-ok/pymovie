...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        spacerItem13 = QtWidgets.QSpacerItem(192, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.dfDarkStdSpinBox = QtWidgets.QDoubleSpinBox(self.tab_11)
        self.dfDarkStdSpinBox.setSingleStep(0.5)
        self.dfDarkStdSpinBox.setProperty("value", 2.0)
        self.dfDarkStdSpinBox.setObjectName("dfDarkStdSpinBox")
        self.horizontalLayout_45.addWidget(self.dfDarkStdSpinBox)
        self.dfDarkStdLabel = QtWidgets.QLabel(self.tab_11)
        self.dfDarkStdLabel.setObjectName("dfDarkStdLabel")
        self.horizontalLayout_45.addWidget(self.dfDarkStdLabel)
        spacerItem14 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_45.addItem(spacerItem14)
        self.dfGainStdSpinBox = QtWidgets.QDoubleSpinBox(self.tab_11)
        self.dfGainStdSpinBox.setSingleStep(0.5)
        self.dfGainStdSpinBox.setProperty("value", 2.0)
        self.dfGainStdSpinBox.setObjectName("dfGainStdSpinBox")
        self.horizontalLayout_45.addWidget(self.dfGainStdSpinBox)
        self.dfGainStdLabel = QtWidgets.QLabel(self.tab_11)
        self.dfGainStdLabel.setObjectName("dfGainStdLabel")
        self.horizontalLayout_45.addWidget(self.dfGainStdLabel)
        ...
        spacerItem15 = QtWidgets.QSpacerItem(193, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dfHelpButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>Dark videos (a recording where no light is allowed on the sensor) and Flat videos (a recording where a constant light level is presented at the sensor sufficient to reach about 75% of max linear intensity) can be used for two purposes: sensor quality control (locating misbehaving pixels); correction for pixel to pixel variations in black level and responsivity to light (gain differences) to reduce light curve noise from these sources.</p><p><span style=\" font-weight:700; color:#ff0000;\">The expected work flow is:</span></p><p>1) Click <span style=\" font-weight:700; color:#0000ff;\">Select &quot;dark&quot; video</span> - this will open the file and enable the <span style=\" font-weight:700; color:#0000ff;\">Calc dark frame</span> button.</p><p>2) Set the desired start and stop frame numbers.</p><p>3) Click the <span style=\" font-weight:700; color:#0000ff;\">show</span> checkboxes to activate lines that designate the ROI (region of interest) - elimination of timestamp information is the primary purpose for the selection, but removing a couple of rows at the top and a couple of columns at the left and right edges is useful to deal with edge effects that are frequently present. The spinners for positioning the ROI lines can be clicked, or edited, or if your mouse has a wheel, spin that wheel while the mouse pointer is in the widget.</p><p>4) Whatever settings for the ROI are chosen MUST be used for both the dark and flat frame generation. This is enforced during the <span style=\" font-weight:700; color:#0000ff;\">Save Dark/Flat frames</span> process.</p><p>5) Click the <span style=\" font-weight:700; color:#0000ff;\">Calc dark frame</span> button to finally form the dark frame.</p><p>6) Click the <span style=\" font-weight:700; color:#0000ff;\">Show dark defects</span> button to view \'dark defects\' - the <span style=\" font-weight:700; color:#0000ff;\">dark std</span> spinner sets the threshold (in multiples of the dark noise found) - any dark frame pixels above this threshold are considered defective.</p><p>7) Click <span style=\" font-weight:700; color:#0000ff;\">Select &quot;flat&quot; video</span> - this will open the file and enable the <span style=\" font-weight:700; color:#0000ff;\">Calc flat frame</span> button.</p><p>8) Click the <span style=\" font-weight:700; color:#0000ff;\">Calc gain frame from dark/flat pair</span> button.</p><p>9) Use the <span style=\" font-weight:700; color:#0000ff;\">dark std</span> and <span style=\" font-weight:700; color:#0000ff;\">gain std</span> spinners to calculate dark defects and gain defects frames (these are multipliers applied to the dark frame noise and the gain frame noise.</p><p>10) Click the <span style=\" font-weight:700; color:#0000ff;\">Save Dark/Flat frames</span> button and give the directory a name that reflects accurately the camera used and the settings used for the recordings.</p><p><span style=\" font-weight:700; color:#ff0000;\">Calculations performed for gain frame:</span></p><p>reference_signal = flatMean - darkMean</p><p>repeat for all pixels (i is the index):</p><p>delta = flat[i] - dark[i]</p><p>if delta &lt;= 0.0 then gain[i] = 0.25  goto_next_pixel</p><p>gain_needed = reference_signal / delta</p><p>if gain_needed &gt; 2.0 then gain[i] = 2.0 else if gain_needed &lt; 0.5 then gain[i] = 0.5 else gain[i] = gain_needed</p><p>goto_next_pixel</p><p><br/></p></body></html>"))
        ...
        self.dfProcessDarkButton.setText(_translate("MainWindow", "Calc dark frame"))
        self.dfSelectFlatVideoButton.setText(_translate("MainWindow", "Select \"flat\" video"))
        self.dfProcessFlatButton.setText(_translate("MainWindow", "Calc flat frame"))
        ...
        self.dfAnalyzeDarkFlatPairButton.setText(_translate("MainWindow", "Calc gain frame from dark/flat pair"))
        self.dfDarkStdLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p>This value sets the threshold (expressed in standard deviations) above which a pixel is considered defective due to high dark level (hot pixel).</p><p><br/></p></body></html>"))
        self.dfDarkStdLabel.setText(_translate("MainWindow", "dark std"))
        self.dfGainStdLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p>This value sets the threshold (expressed in standard deviations) above which a pixel is considered defective due to gain error.</p><p>The comparison is against the median gain.</p></body></html>"))
        self.dfGainStdLabel.setText(_translate("MainWindow", "gain std"))
        self.dfSaveAvailableFramesButton.setText(_translate("MainWindow", "Save Dark/Flat frames"))
        self.dfShowFlatFrameButton.setText(_translate("MainWindow", "Show flat"))
        self.dfShowGainFrameButton.setText(_translate("MainWindow", "Show gain"))
        self.dfShowGainDefectFrameButton.setText(_translate("MainWindow", "Show gain defects"))
        self.dfShowDarkFrameButton.setText(_translate("MainWindow", "Show dark"))
