...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_10.addWidget(self.metadataButton)
        ...
        self.createAVIWCSfolderButton = QtWidgets.QPushButton(self.widget)
        self.createAVIWCSfolderButton.setObjectName("createAVIWCSfolderButton")
        self.horizontalLayout_12.addWidget(self.createAVIWCSfolderButton)
        self.horizontalLayout_12.setStretch(0, 2)
        self.horizontalLayout_12.setStretch(1, 2)
        self.verticalLayout_3.addLayout(self.horizontalLayout_12)
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.flipImagesLeftToRightCheckBox = QtWidgets.QCheckBox(self.widget)
        self.flipImagesLeftToRightCheckBox.setObjectName("flipImagesLeftToRightCheckBox")
        self.horizontalLayout_6.addWidget(self.flipImagesLeftToRightCheckBox)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_6.addItem(spacerItem)
        self.gammaLabel = QtWidgets.QLabel(self.widget)
        self.gammaLabel.setObjectName("gammaLabel")
        self.horizontalLayout_6.addWidget(self.gammaLabel)
        self.gammaSettingOfCamera = QtWidgets.QDoubleSpinBox(self.widget)
        ...
        self.horizontalLayout_6.addWidget(self.gammaSettingOfCamera)
        ...
        self.flipImagesTopToBottomCheckBox = QtWidgets.QCheckBox(self.widget)
        self.flipImagesTopToBottomCheckBox.setObjectName("flipImagesTopToBottomCheckBox")
        self.horizontalLayout_3.addWidget(self.flipImagesTopToBottomCheckBox)
        ...
        self.horizontalLayout.addWidget(self.plotSymbolSizeLabel)
        ...
        self.horizontalLayout.addWidget(self.plotSymbolSizeSpinBox)
        ...
        self.label_4.setMinimumSize(QtCore.QSize(29, 0))
        self.label_4.setText("")
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_8.addWidget(self.label_4)
        self.cascadeCheckBox = QtWidgets.QCheckBox(self.widget)
        ...
        self.horizontalLayout_8.addWidget(self.cascadeCheckBox)
        ...
        self.horizontalLayout_8.addWidget(self.lunarCheckBox)
        spacerItem6 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_8.addItem(spacerItem6)
        self.twoPointHelpButton = QtWidgets.QToolButton(self.widget)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.twoPointHelpButton.setFont(font)
        self.twoPointHelpButton.setObjectName("twoPointHelpButton")
        self.horizontalLayout_8.addWidget(self.twoPointHelpButton)
        self.transportHelp = QtWidgets.QToolButton(self.widget)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.transportHelp.setFont(font)
        self.transportHelp.setObjectName("transportHelp")
        self.horizontalLayout_8.addWidget(self.transportHelp)
        ...
        self.vtiSpacerLabel = QtWidgets.QLabel(self.widget)
        self.vtiSpacerLabel.setText("")
        self.vtiSpacerLabel.setObjectName("vtiSpacerLabel")
        self.horizontalLayout_17.addWidget(self.vtiSpacerLabel)
        self.lprofileButtonSpacingLabel = QtWidgets.QLabel(self.widget)
        self.lprofileButtonSpacingLabel.setText("")
        self.lprofileButtonSpacingLabel.setObjectName("lprofileButtonSpacingLabel")
        self.horizontalLayout_17.addWidget(self.lprofileButtonSpacingLabel)
        self.loadCustomProfilesButton = QtWidgets.QPushButton(self.widget)
        self.loadCustomProfilesButton.setObjectName("loadCustomProfilesButton")
        self.horizontalLayout_17.addWidget(self.loadCustomProfilesButton)
        self.clearOcrDataButton = QtWidgets.QPushButton(self.widget)
        self.clearOcrDataButton.setObjectName("clearOcrDataButton")
        self.horizontalLayout_17.addWidget(self.clearOcrDataButton)
        ...
        self.loadHotPixelProfileButton = QtWidgets.QPushButton(self.widget)
        self.loadHotPixelProfileButton.setObjectName("loadHotPixelProfileButton")
        self.horizontalLayout_9.addWidget(self.loadHotPixelProfileButton)
        self.createHotPixelListButton = QtWidgets.QPushButton(self.widget)
        self.createHotPixelListButton.setObjectName("createHotPixelListButton")
        self.horizontalLayout_9.addWidget(self.createHotPixelListButton)
        spacerItem11 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_9.addItem(spacerItem11)
        self.applyHotPixelRemovalCheckBox = QtWidgets.QCheckBox(self.widget)
        self.applyHotPixelRemovalCheckBox.setObjectName("applyHotPixelRemovalCheckBox")
        self.horizontalLayout_9.addWidget(self.applyHotPixelRemovalCheckBox)
        ...
        self.finderRedactTopLinesLabel = QtWidgets.QLabel(self.widget)
        ...
        self.horizontalLayout_11.addWidget(self.finderRedactTopLinesLabel)
        self.redactLinesTopEdit = QtWidgets.QLineEdit(self.widget)
        ...
        self.horizontalLayout_11.addWidget(self.redactLinesTopEdit)
        self.redactLinesBottomEdit = QtWidgets.QLineEdit(self.widget)
        ...
        self.horizontalLayout_11.addWidget(self.redactLinesBottomEdit)
        self.label_2 = QtWidgets.QLabel(self.widget)
        self.label_2.setMinimumSize(QtCore.QSize(5, 0))
        self.label_2.setText("")
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_11.addWidget(self.label_2)
        self.finderRedactBottomLinesLabel = QtWidgets.QLabel(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_11.addWidget(self.finderRedactBottomLinesLabel)
        ...
        self.finderThresholdLabel = QtWidgets.QLabel(self.widget)
        self.finderThresholdLabel.setObjectName("finderThresholdLabel")
        self.horizontalLayout_11.addWidget(self.finderThresholdLabel)
        self.finderThresholdEdit = QtWidgets.QLineEdit(self.widget)
        ...
        self.horizontalLayout_11.addWidget(self.finderThresholdEdit)
        ...
        self.horizontalLayout_7.addWidget(self.manualWcsButton)
        ...
        self.horizontalLayout_7.addWidget(self.frameToFitsButton)
        self.h1 = QtWidgets.QLabel(self.widget)
        self.h1.setEnabled(False)
        self.h1.setText("")
        self.h1.setObjectName("h1")
        self.horizontalLayout_7.addWidget(self.h1)
        self.pixelHeightLabel = QtWidgets.QLabel(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pixelHeightEdit = QtWidgets.QLineEdit(self.widget)
        ...
        self.pixelWidthEdit = QtWidgets.QLineEdit(self.widget)
        ...
        self.pixelWidthLabel = QtWidgets.QLabel(self.widget)
        ...
        self.horizontalLayout_4.addWidget(self.documentationPushButton)
        ...
        self.horizontalLayout_4.addWidget(self.demoMeanPushButton)
        self.view3DButton = QtWidgets.QPushButton(self.widget)
        self.view3DButton.setObjectName("view3DButton")
        self.horizontalLayout_4.addWidget(self.view3DButton)
        spacerItem13 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_4.addItem(spacerItem13)
        self.runPyote = QtWidgets.QCheckBox(self.widget)
        self.runPyote.setEnabled(False)
        self.runPyote.setObjectName("runPyote")
        self.horizontalLayout_4.addWidget(self.runPyote)
        ...
        self.widget1 = QtWidgets.QWidget(self.splitterOne)
        ...
        self.textOut = QtWidgets.QTextEdit(self.widget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        ...
        self.textOutLabel = QtWidgets.QLabel(self.widget1)
        ...
        self.thumbOneView = ImageView(self.layoutWidget1)
        self.thumbOneView.setObjectName("thumbOneView")
        self.verticalLayout_2.addWidget(self.thumbOneView)
        self.thumbnailOneLabel = QtWidgets.QLabel(self.layoutWidget1)
        ...
        self.thumbTwoView = ImageView(self.layoutWidget1)
        self.thumbTwoView.setObjectName("thumbTwoView")
        self.verticalLayout.addWidget(self.thumbTwoView)
        self.thumbnailTwoLabel = QtWidgets.QLabel(self.layoutWidget1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.createAVIWCSfolderButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>This button will only be active when a \'bare\' avi is opened (rather than from an AVI-WCS folder).</p><p>This button has been added because of the decision to perform timestamp OCR only on avi files that live in an AVI-WCS folder. While that is a good way to collect the (many) files that result from OCR, WCS, PyMovie, and PyOTE operations, there are likely to be users that have opted for a flat (or flatter) directory structure. This button will ease (hopefully) the transition to an alternate file organization.</p><p>When clicked, a Directory dialog will appear to allow the user to select (or even create) the directory that is to hold the newly created (and filled) AVI-WCS folder. It defaults to the directory that holds the opened avi.</p><p>The name of the newly created AVI-WCS folder will always be the name of the avi file with its outermost extension removed.</p><p>The folder will then be populated with an alias (Mac) to the avi or a Shortcut (Windows) to the avi, so this file structure will be frugal with file space.</p><p>Finally, behind-the-scenes, the program simulates the user clicking on <span style=\" font-weight:600; color:#fc0107;\">Select AVI-WCS folder</span> and then clicking on <span style=\" font-weight:600; color:#fc0107;\">Accept</span> (possible because after a \'creation of AVI-WCS folder\', the default directory/folder is set to that of the newly created folder). We could not imagine a workflow where a user would <span style=\" font-weight:600;\">not</span> want to immediately start processing the avi from within an AVI-WCS folder, so the automation seems reasonable and unlikely to get in anyone\'s way.<br/></p></body></html>"))
        ...
        self.gammaLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p>If the video was recorded with a gamma setting other than 1.00, put that value in this spin box (it can be directly editted if the 0.05 steps of the spinner are inappropriate).</p><p>If a value other than 1.00 is present in this edit box, all images will have a gamma reversal applied on a pixel by pixel basis. This is desirable when more accurate photometrics are needed as it improves the linearity of the pixel response to light.</p><p>The reversal equation used is: <span style=\" font-weight:600; color:#fc0107;\">xnew = maxval * ((x / maxval) ^ (1 / gamma))</span> where maxval is either 65535 (for 16 bit images) or 255 (for 8 bit images).</p></body></html>"))
        self.gammaLabel.setText(_translate("MainWindow", "gamma"))
        self.saveApertureState.setToolTip(_translate("MainWindow", "<html><head/><body><p>This function is only available for videos contained in an AVI-WCS folder or a FITS folder.</p><p>Clicking this button will first save the frame number that is currrently being viewed, and then will record all the apertures (and all their properties) for later restoration.</p><p>To restore a previous configuration, first open the folder, then click the <span style=\" font-weight:600; color:#fc0107;\">Restore aperture group</span> button.</p></body></html>"))
        self.saveApertureState.setText(_translate("MainWindow", "Save aperture group"))
        self.restoreApertureState.setToolTip(_translate("MainWindow", "<html><head/><body><p>This function is only available for videos contained in an AVI-WCS folder or a FITS folder.</p><p>Clicking this button will restore a previously saved aperture group with all the property values present when the <span style=\" font-weight:600; color:#fc0107;\">Save aperture group</span> button was clicked.</p><p>Note that this action will first remove all current apertures, including the one that was automatically placed through an available WCS solution. Typically the target aperture would have been included in the save aperture group anyway.</p><p>It will then position the file to the frame that was current when the \'save\' was performed and recreate all apertures present at the time of \'saving\' on that frame.</p></body></html>"))
        ...
        self.transportHelp.setText(_translate("MainWindow", "Help for image area -->"))
        ...
        self.createHotPixelListButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>Click this button after placing apertures on all of the hot pixels present in the image.</p><p>This list will be used to remove those hot-pixels from each frame that is to be used in the creation of a &quot;finder&quot; image. This is desirable because hot-pixels, which do not move, often interfere with the algorithm that is used to align/stack frames --- a Fourier Correlation calculation is used to determine the x and y offsets needed to align successive images --- it performs that correlation over all pixels in the image and pixels that are bright and don\'t move can keep the algorithm from detecting a needed xy shift.</p><p>It is also useful to remove hot pixel groups so that they don\'t add confusing asterisms --- it\'s easier to correlate a finder image without spurious \'stars\' with a sky chart.</p><p>Use the <span style=\" font-weight:600; color:#fc0107;\">load/save/edit hot-pixels profiles</span> button to the left if you want to to name and save this list into a hot-pixel list database for future use. Since the hot pixel constellation for a given camera/camera setting will change slowly with time, such saved profiles can be quickly recalled and will often be sufficient for hot pixel removal. At the very least, it will serve as good starting point.</p></body></html>"))
        self.createHotPixelListButton.setText(_translate("MainWindow", "extract hot-pixels from apertures"))
        ...
        self.stackFramesButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>To assist in locating a dim target star, an enhanced &quot;finder&quot; image can be generated by aligning and stacking (summing) a number of frames.</p><p>This intensified image can then be used for positioning an aperture on the target star, even though that star might be invisible in a single frame.</p><p>There are three available algorithms for performing image alignment: </p><p>1) Use an aperture with a name that starts with \'stack\' to follow a bright star through the frames that are to be aligned --- the xy translations of that star are used subsequently to align the frames. This is the simplest and most reliable method to use and takes priority over methods 2 and 3. Just place a snap-to-blob aperture on the desired star while at the desired starting frame, name it \'stacker\', fill in the top and bottom redact numbers and the number of frames to stack. The &quot;finder&quot; threshold data is not used in any way by this algorithm. Click on Generate &quot;finder&quot;. What you will see is an &quot;analysis&quot; run (with the \'stack\' aperture following the star), followed by an image alignment run, followed by the appearance of the &quot;finder&quot; image. Note: This is an actual analysis run so data will be collected.</p><p>2) Using a 2 point tracking path that has been established for the video. This is more tedious to set up but also works very well although it will not follow windshake. Use 1) whenever there is much windshake. As in 1), the &quot;finder&quot; threshold data is not used.</p><p>3) Alignment via Fourier Correlation: <span style=\" font-weight:600; color:#fc0107;\">NOTE:</span> in order for this procedure to work, it is <span style=\" font-weight:600; color:#fc0107;\">essential</span> to remove any timestamp overlay that may be present. That is because, unlike a program like RegiStax that registers frames using star centroids, the procedure used here is to apply the \'Fourier transform phase correlation algorithm\' to calculate the pixel offset between the reference frame and the subsequent frames. If there is anything in the image that does not move (like a timestamp), that math calculation will fail and the resulting \'stack\' will not be useful --- it will register the frames on the timestamp rather than the star field. The &quot;finder&quot; threshold value, which is set automatically if left empty, can be manually set so that only the brightest pixels are used during the correlation calculation. Judicious use of the contrast control can give you a good way of estimating an effective number to put in this box --- slide the bottom limit up until the resulting image only contains bright pixels from stars. Use a hot pixel list to suppress spurious bright pixels.</p><p><span style=\" font-weight:600; color:#fc0107;\">General notes:</span></p><p>The edit boxes labelled \'redact top\' and \'redact bottom\' specify how many lines to remove from the top and bottom of the image to get rid of timestamp or other non-image data..</p><p>The edit box labelled \'num frames\' specifies how many frames to register and sum. For the purpose of locating a star that can produce an occultation light curve, a number of frames in the range of 100 to 400 is effective. If this number is set too high, while the target star might become visible in this enhanced image, it is likely to be lost in quantization and noise effects when frame by frame aperture photometry is attempted.</p><p><span style=\" font-weight:600; color:#fc0107;\">NOTE:</span> if timestamps were present (but redacted), the &quot;finder&quot; image will show the timestamp of the first frame in the stack, the so-called reference frame that all others are aligned/registered against to build the \'stack\'.</p></body></html>"))
