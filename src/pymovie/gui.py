...
"aperture placement."))
        ...
        self.pixelPanelInfoButton.setToolTip(_translate("MainWindow", "Click me for lots of clear and useful information"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_8), _translate("MainWindow", "experimental"))
