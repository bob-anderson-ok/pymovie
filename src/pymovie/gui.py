...
"aperture placement."))
        ...
        self.allowNewVersionPopupCheckbox.setToolTip(_translate("MainWindow", "<html><head/><body><p>This splash screen can be disabled on the <span style=\" font-weight:700; color:#0000ff;\">Misc.</span> tab.</p><p><span style=\" font-weight:700; color:#ff0000;\">What\'s new with this version:</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">Centering/tracking of fixed radius masks (in static apertures) now finds the center position of the mass centroid calculated using the nThBrightPixel algorithm conceived and tested by A. G. Basden (reported in </span><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#ff0000;\">Centroids using Brightest Pixel Algorithm by A. G. Basden, et al, MNRAS, 2011</span><span style=\" font-family:\'Arial\',\'sans-serif\';\">) <br/><br/>This operates by finding the n brightest pixels in the mask, setting all other pixel values to zero, and calculating the x,y centroid of the remaining ‘mass’.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">There is a new button pair added under the image labelled </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#ff0000;\">AP analysis</span><span style=\" font-family:\'Arial\',\'sans-serif\';\"> (Aperture Photometry) and </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#ff0000;\">NRE analysis</span><span style=\" font-family:\'Arial\',\'sans-serif\';\"> (Noise Reduction Extraction) replacing the single button that had been labeled </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#ff0000;\">Analysis</span><span style=\" font-family:\'Arial\',\'sans-serif\';\">. Aperture photometry is unchanged and works exactly as it has in the past. The new method of extracting a light curve with low noise is explained below. Aperture photometry with an appropriately sized fixed circular mask will usually give the best results, but determining the proper mask size to achieve the best SNR can be problematic. The NRE algorithm is very robust and will always produce good results if not the best. It is a good starting point for marginal observations. Then try more standard AP techniques with both fixed and dynamic masks. As always, the fianl metric is SNR and the False Positive margin.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#ff0000;\">Noise Reduction Extraction has been added:</span><span style=\" font-family:\'Arial\',\'sans-serif\';\"><br/></span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-size:12pt;\"><br/></span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700;\">Background: </span><span style=\" font-family:\'Arial\',\'sans-serif\';\">Optimal extraction for imaging photometry was introduced by Tim Naylor in his 1998 paper titled: </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#ff0000;\">An optimal extraction algorithm for imaging photometry. [ Mon. Not. R. Astron. Soc. 296, 339-346 (1998)]</span><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\">.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\">Naylor\'s algorithm utilizes a two-dimensional gaussian as an approximation to the psf of stars in the image and demonstrates that this is an effective approximation in practice. Using this analytic psf, the paper describes how to calculate a weighted mask that lowers the noise in a star intensity measurement by giving a larger weight to those pixel that have a higher SNR and a lower weight to dimmer, noisier pixels - </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#000000;\">this is the core idea in all optimal extraction schemes</span><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\">.</span></p><p>Noise Reduction Extraction is a version of Optimal Extraction inspired by an observation made by  V. Marchiori in the paper: <span style=\" font-weight:700; color:#ff0000;\">In-Flight photometry extraction of PLATO targets, Optimal apertures for detecting extrasolar planets. arXiv:1906.00892v1 [Astro-ph.IM] 3 Jun 2019.</span><br/><br/><span style=\" font-family:\'Arial\',\'sans-serif\';\">That paper (in section 4.6.1 Gradient mask) develops an equation for computing the optimal weights for the pixels in a star image with an arbitrary psf. The inspirational (for me) observation was made a little later in the paper: it says that the weights calculated by their equation resemble very closely the weights from a gaussian mask and goes on to show that the results obtained using the gaussian mask were nearly as good as using the mathematically correct weights of a gradient mask. Noting that the psf of the star recorded by PLATO optics is a gaussian, PyMovie takes that idea to an extreme and uses the </span><span style=\" font-family:\'Arial\',\'sans-serif\'; text-decoration: underline;\">measured</span><span style=\" font-family:\'Arial\',\'sans-serif\';\"> psf of the target star as the basis of the weights to use for optimal extraction.<br/><br/>In short: the psf of the target (or a comparable star) is measured by adding a sequence of frames centered by the nThBrightPixel algorithm described above. Appropriately normalized, this experimental psf is the basis for the weights that are subsequently used in light curve extraction. This has proven to be both robust and usable, even for occultations where the target completely disappears.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#ff0000;\">Note:</span></p><p>Both of the referenced papers develop an equation for weights that are mathematically optimum, given the model that they use. Because the procedure used by PyMovie does not have an underlying mathematical procedure for determining the weights used that come from an optimization calculation, the term Optimal Extraction is not appropriate. Instead, we use the term Noise Reduction Extraction. </p><p>Its efficacy has been proven by testing, not by mathematics.</p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; font-size:10pt; font-weight:700; color:#ff0000;\">Important tip:</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; font-size:10pt;\">Before doing an analysis, be sure to set the csv order in which the aperture data columns will be output to the csv file. This is easily done by clicking on the </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-size:10pt; font-weight:700; color:#0000ff;\">Examine/change aperture settings</span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-size:10pt;\"> button. In the panel that appears, the rightmost column is titled </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-size:10pt; font-weight:700; color:#0000ff;\">csv output order</span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-size:10pt;\">. Use that column to set the expected best aperture for the target to 0 - this is because when PyOTE reads this file, it will be the first lightcurve displayed. With the latest version of PyOTE, all the other data sets/lightcurves will be accessible through a drop-down list and the order of items in this list are controlled by their order in the csv file, so set the csv order to make this list order be convenient for you.</span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-size:12pt;\"><br/><br/></span></p></body></html>"))
