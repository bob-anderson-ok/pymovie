...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.vtiThresholdLabel = QtWidgets.QLabel(self.widget)
        self.vtiThresholdLabel.setObjectName("vtiThresholdLabel")
        self.horizontalLayout_17.addWidget(self.vtiThresholdLabel)
        self.vtiThresholdSpinner = QtWidgets.QSpinBox(self.widget)
        self.vtiThresholdSpinner.setMaximum(255)
        self.vtiThresholdSpinner.setSingleStep(5)
        self.vtiThresholdSpinner.setProperty("value", 240)
        self.vtiThresholdSpinner.setObjectName("vtiThresholdSpinner")
        self.horizontalLayout_17.addWidget(self.vtiThresholdSpinner)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.vtiThresholdLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p>During timestamp optical character recognition, the pixels in the character selection box are set to zero if they are less than the value in this spinner. This is useful in suppressing the background (stars; bright sky) that surrounds the character pixels.</p></body></html>"))
        self.vtiThresholdLabel.setText(_translate("MainWindow", "threshold: "))
