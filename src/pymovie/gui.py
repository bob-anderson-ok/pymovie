...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.fileInUseEdit = QtWidgets.QLineEdit(self.widget)
        ...
        self.saveApertureState = QtWidgets.QPushButton(self.widget)
        self.saveApertureState.setObjectName("saveApertureState")
        self.horizontalLayout_6.addWidget(self.saveApertureState)
        self.restoreApertureState = QtWidgets.QPushButton(self.widget)
        ...
        self.applyHotPixelRemovalCheckBox = QtWidgets.QCheckBox(self.tab_3)
        self.applyHotPixelRemovalCheckBox.setObjectName("applyHotPixelRemovalCheckBox")
        self.verticalLayout_6.addWidget(self.applyHotPixelRemovalCheckBox)
        ...
        self.alignWithFourierCorrInfoButton = QtWidgets.QPushButton(self.tab)
        self.alignWithFourierCorrInfoButton.setObjectName("alignWithFourierCorrInfoButton")
        self.horizontalLayout_11.addWidget(self.alignWithFourierCorrInfoButton)
        ...
        self.finderThresholdLabel = QtWidgets.QLabel(self.tab)
        self.finderThresholdLabel.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.finderThresholdLabel.setObjectName("finderThresholdLabel")
        self.horizontalLayout_16.addWidget(self.finderThresholdLabel)
        self.finderThresholdEdit = QtWidgets.QLineEdit(self.tab)
        self.finderThresholdEdit.setMinimumSize(QtCore.QSize(60, 0))
        self.finderThresholdEdit.setMaximumSize(QtCore.QSize(60, 16777215))
        self.finderThresholdEdit.setObjectName("finderThresholdEdit")
        self.horizontalLayout_16.addWidget(self.finderThresholdEdit)
        self.verticalLayout_3.addLayout(self.horizontalLayout_16)
        self.stackFramesButton = QtWidgets.QPushButton(self.tab)
        self.stackFramesButton.setObjectName("stackFramesButton")
        self.verticalLayout_3.addWidget(self.stackFramesButton)
        ...
        self.gridLayout_6.addItem(spacerItem16, 1, 1, 1, 1)
        ...
        spacerItem19 = QtWidgets.QSpacerItem(20, 26, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.lunarCheckBox = QtWidgets.QCheckBox(self.tab_8)
        self.lunarCheckBox.setObjectName("lunarCheckBox")
        self.verticalLayout_12.addWidget(self.lunarCheckBox)
        self.useYellowMaskCheckBox = QtWidgets.QCheckBox(self.tab_8)
        self.useYellowMaskCheckBox.setObjectName("useYellowMaskCheckBox")
        self.verticalLayout_12.addWidget(self.useYellowMaskCheckBox)
        self.view3DButton = QtWidgets.QPushButton(self.tab_8)
        self.view3DButton.setObjectName("view3DButton")
        self.verticalLayout_12.addWidget(self.view3DButton)
        self.gridLayout_8.addLayout(self.verticalLayout_12, 0, 1, 1, 1)
        spacerItem21 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_8.addItem(spacerItem21, 0, 0, 1, 1)
        spacerItem22 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_8.addItem(spacerItem22, 1, 1, 1, 1)
        ...
        self.widget1.setGeometry(QtCore.QRect(10, 71, 161, 154))
        ...
        self.appSizeToolButton = QtWidgets.QToolButton(self.widget1)
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.defAppSize51RadioButton = QtWidgets.QRadioButton(self.widget1)
        ...
        self.defAppSize41RadioButton = QtWidgets.QRadioButton(self.widget1)
        ...
        self.defAppSize31RadioButton = QtWidgets.QRadioButton(self.widget1)
        ...
        self.defAppSize21RadioButton = QtWidgets.QRadioButton(self.widget1)
        ...
        self.defAppSize11RadioButton = QtWidgets.QRadioButton(self.widget1)
        ...
        self.widget2 = QtWidgets.QWidget(self.tab_9)
        self.widget2.setGeometry(QtCore.QRect(200, 71, 155, 148))
        ...
        self.sigmaLevelToolButton = QtWidgets.QToolButton(self.widget2)
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.oneSigmaRadioButton = QtWidgets.QRadioButton(self.widget2)
        ...
        self.twoSigmaRadioButton = QtWidgets.QRadioButton(self.widget2)
        ...
        self.threeSigmaRadioButton = QtWidgets.QRadioButton(self.widget2)
        ...
        self.widget3.setGeometry(QtCore.QRect(380, 40, 192, 208))
        ...
        self.defaultMaskRadiusToolButton = QtWidgets.QToolButton(self.widget3)
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.frameView = ImageView(self.layoutWidget)
        ...
        self.runPyote = QtWidgets.QCheckBox(self.layoutWidget)
        ...
        self.transportMaxLeft = QtWidgets.QToolButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.transportBigLeft = QtWidgets.QToolButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.transportSmallLeft = QtWidgets.QToolButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.transportMinusOneFrame = QtWidgets.QToolButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.transportPlayLeft = QtWidgets.QToolButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.transportPause = QtWidgets.QToolButton(self.layoutWidget)
        ...
        self.transportAnalyze = QtWidgets.QToolButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.transportPlayRight = QtWidgets.QToolButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.transportPlusOneFrame = QtWidgets.QToolButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.transportSmallRight = QtWidgets.QToolButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.transportBigRight = QtWidgets.QToolButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.transportMaxRight = QtWidgets.QToolButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.transportCsv = QtWidgets.QToolButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.transportPlot = QtWidgets.QToolButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.transportCurrentFrameLabel = QtWidgets.QLabel(self.layoutWidget)
        ...
        self.currentFrameSpinBox = QtWidgets.QSpinBox(self.layoutWidget)
        ...
        self.stopAtFrameSpinBox = QtWidgets.QSpinBox(self.layoutWidget)
        ...
        self.transportStopAtFrameLabel = QtWidgets.QLabel(self.layoutWidget)
        ...
        self.transportMark = QtWidgets.QToolButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.transportReturnToMark = QtWidgets.QToolButton(self.layoutWidget)
        ...
        self.transportClearData = QtWidgets.QToolButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.layoutWidget1 = QtWidgets.QWidget(self.splitterOne)
        ...
        self.textOut = QtWidgets.QTextEdit(self.layoutWidget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        ...
        self.textOutLabel = QtWidgets.QLabel(self.layoutWidget1)
        ...
        self.thumbOneView = ImageView(self.layoutWidget2)
        self.thumbOneView.setObjectName("thumbOneView")
        self.verticalLayout_2.addWidget(self.thumbOneView)
        self.thumbnailOneLabel = QtWidgets.QLabel(self.layoutWidget2)
        ...
        self.thumbTwoView = ImageView(self.layoutWidget2)
        self.thumbTwoView.setObjectName("thumbTwoView")
        self.verticalLayout.addWidget(self.thumbTwoView)
        self.thumbnailTwoLabel = QtWidgets.QLabel(self.layoutWidget2)
        ...
        self.horizontalLayout_28.addWidget(self.splitterThree)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.readAviFileButton.setText(_translate("MainWindow", "Open AVI/SER file"))
        self.createAVIWCSfolderButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>This button will only be active when a \'bare\' avi/ser is opened (rather than from an AVI/SER-WCS folder).</p><p>This button has been added because of the decision to perform timestamp OCR only on files that live in an AVI/SER-WCS folder. While that is a good way to collect the (many) files that result from OCR, WCS, PyMovie, and PyOTE operations, there are likely to be users that have opted for a flat (or flatter) directory structure. This button will ease (hopefully) the transition to an alternate file organization.</p><p>When clicked, a Directory dialog will appear to allow the user to select (or even create) the directory that is to hold the newly created (and filled) AVI/SER-WCS folder. It defaults to the directory that holds the opened video file.</p><p>The name of the newly created AVI/SER-WCS folder will always be the name of the video file with its outermost extension removed.</p><p>The folder will then be populated with an alias (Mac) to the avi or a Shortcut (Windows) to the avi, so this file structure will be frugal with file space.</p><p>Finally, behind-the-scenes, the program simulates the user clicking on <span style=\" font-weight:600; color:#fc0107;\">Select AVI/SER-WCS folder</span> and then clicking on <span style=\" font-weight:600; color:#fc0107;\">Accept</span> (possible because after a \'creation of AVI/SER-WCS folder\', the default directory/folder is set to that of the newly created folder). We could not imagine a workflow where a user would <span style=\" font-weight:600;\">not</span> want to immediately start processing the video from within an AVI/SER-WCS folder, so the automation seems reasonable and unlikely to get in anyone\'s way.<br/></p></body></html>"))
        self.createAVIWCSfolderButton.setText(_translate("MainWindow", "Create AVI/SER-WCS folder from file"))
        self.metadataButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>Clicking this button will show (in the text box in the lower left corner of the GUI) all metadata from the currently displayed .fits/.ser file.</p><p>\'metadata\' is the text information that is present in the header of the .fits/.ser file.</p></body></html>"))
        self.metadataButton.setText(_translate("MainWindow", "Show FITS/SER metadata"))
        ...
        self.vtiSelectComboBox.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600; color:#fc0107;\">Note: this control will only be active when an AVI-WCS folder is in use.</span></p><p>This control provides a drop-down list of VTI (video time inserter) models for which OCR (optical character recognition) timestamp processing is available. Selecting an entry will cause a constellation of character extraction boxes to be displayed on the image (which automatically switches to field view).</p><p>If the character selection boxes enclose the correct characters and are well-aligned, then you\'re ready to go.</p><p>If you\'re dealing with a Kiwi timestamp, which has two positions for the timestamp character --- a left position and a right position --- you should first select the position that best encloses the timestamp characters in the displayed frame.</p><p>If the character boxes are not well aligned, use the jogging buttons to the right to achieve a better alignment.</p><p><span style=\" font-weight:600; text-decoration: underline; color:#fc0107;\">Note: Kiwi timestamp boxes must only be adjusted (jogged) when the timestamp position is the same as that of frame 1.</span></p></body></html>"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_6), _translate("MainWindow", "OCR"))
        self.createHotPixelListButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>Click this button after placing apertures on all of the hot pixel groups present in the image.</p><p>This list will be used to remove those hot-pixels from each frame that is to be used in the creation of a &quot;finder&quot; image. This is desirable because hot-pixels, which do not move, often interfere with one of the algorithms that are used to align/stack frames --- in the <span style=\" font-weight:600; color:#fc0107;\">Align: image correlation</span> method, a Fourier Correlation calculation is used to determine the x and y offsets needed to align successive images --- it performs that correlation over all pixels in the image and pixels that are bright and don\'t move can keep that algorithm from detecting a needed xy shift.</p><p>It is also useful to remove hot pixel groups so that they don\'t add confusing asterisms --- it\'s easier to correlate a finder image without spurious \'stars\' with a sky chart.</p><p>Use the <span style=\" font-weight:600; color:#fc0107;\">load/save/edit hot-pixels profiles</span> button below if you want to to name and save this list into a hot-pixel list database for future use. Since the hot pixel constellation for a given camera/camera setting will change slowly with time, such saved profiles can be quickly recalled and will often be sufficient for hot pixel removal. At the very least, it will serve as good starting point.</p></body></html>"))
        ...
        self.applyHotPixelRemovalCheckBox.setToolTip(_translate("MainWindow", "<html><head/><body><p>If a hot pixel list is loaded, checking this box will cause the erasure of hot pixels during visual examination of the video. It will be automatically unchecked whenever an analysis (data capture) is started so that light curve intensities will remain unaffected by the presence of a hot pixel list.</p><p><span style=\" font-weight:600; color:#fc0107;\">However</span>, after an analysis is started, you <span style=\" font-weight:600; color:#fc0107;\">can</span> re-enable hot pixel erasure if you really <span style=\" text-decoration: underline;\">really</span> think it can help the light curve extraction. <span style=\" font-weight:600; color:#fc0107;\">Beware:</span> there is always the possibility of gerating a spurious \'dip\' in a light curve that has a hot pixel group overlapping a star image, particularly on a drift-through video.</p><p>The primary reason for a hot pixel list is its use during the generation of a &quot;finder&quot; image where it is often critical to the success of that operation. It is not intended to \'correct\' a star image that overlaps a hot pixel group.</p><p><span style=\" font-weight:600; color:#0000ff;\">Hot pixel erasure is performed on a frame by frame basis by calculating an average background for that frame through a Robust Mean calculation performed on a 51 x 51 pixel aperture placed at the center of the frame. Then, this value is used to overwrite the pixel value at each coordinate point present in the hot pixel list.</span></p></body></html>"))
        self.applyHotPixelRemovalCheckBox.setText(_translate("MainWindow", "Erase hot pixels"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("MainWindow", "Hot Pixels"))
        self.alignWithStarInfoButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>To assist in locating a dim target star, an enhanced &quot;finder&quot; image can be generated by aligning and stacking (summing) a number of frames.</p><p>This intensified image can then be used for positioning an aperture on the target star, even though that star might be invisible in a single frame.</p><p>The simplest and easiest to use method for performing image alignment is use an aperture with a name that starts with \'stack\' to follow a bright star through the frames that are to be aligned --- the xy translations of that star are used subsequently to align the frames. </p><p>To use the <span style=\" font-weight:600; color:#fc0107;\">Align: star</span> method: </p><p>1) Place a snap-to-blob aperture on the desired star while at the desired starting frame.</p><p>2) Give that aperture a name that starts with \'stack\'</p><p>3) Fill in the top and bottom redact numbers (used for removing timestamp overlays).</p><p>4) Specify the number of frames to stack. </p><p>5) Click on Generate &quot;finder&quot;. What you will see is an &quot;analysis&quot; run (with the \'stack\' aperture following the star), followed by an image alignment run, followed by the appearance of the &quot;finder&quot; image. Note: This is an actual analysis run so data will be collected.</p><p><span style=\" font-weight:600; color:#fc0107;\">Note:</span> The &quot;finder&quot; threshold data is not used in any way by this algorithm. </p><p><span style=\" font-weight:600; color:#fc0107;\">General notes:</span></p><p>The edit boxes labelled \'redact top\' and \'redact bottom\' specify how many lines to remove from the top and bottom of the image to get rid of timestamp or other non-image data.</p><p>The edit box labelled \'num frames\' specifies how many frames to register and sum. For the purpose of locating a star that can produce an occultation light curve, a number of frames in the range of 100 to 400 is effective. If this number is set too high, while the target star might become visible in this enhanced image, it is likely to be lost in quantization and noise effects when frame by frame aperture photometry is attempted.</p><p><span style=\" font-weight:600; color:#fc0107;\">Note:</span> if timestamps were present (but redacted), the &quot;finder&quot; image will show the timestamp of the first frame in the stack, the so-called reference frame that all others are aligned/registered against to build the \'stack\'.</p></body></html>"))
        self.alignWithStarInfoButton.setText(_translate("MainWindow", "Align: star"))
        self.alignWithFourierCorrInfoButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>To assist in locating a dim target star, an enhanced &quot;finder&quot; image can be generated by aligning and stacking (summing) a number of frames.</p><p>This intensified image can then be used for positioning an aperture on the target star, even though that star might be invisible in a single frame.</p><p><span style=\" font-weight:600; color:#fc0107;\">Align: image correlation</span> aligns frames by by finding the xy translation for frame n that best correlates with the starting (reference) frame. That correlation includes all pixels in the frame. While a powerful technique, it is also \'fussy\' because the correlation does include all frame pixels in the calculation.</p><p><span style=\" font-weight:600; color:#fc0107;\">Note:</span> in order for this procedure to work, it is <span style=\" font-weight:600; color:#fc0107;\">essential</span> to remove any timestamp overlay that may be present. That is because, unlike a program like RegiStax that registers frames using star centroids, the procedure used here is to apply the \'Fourier transform phase correlation algorithm\' to calculate the pixel offset between the reference frame and the subsequent frames. If there is anything in the image that does not move (like a timestamp), that math calculation will fail and the resulting \'stack\' will not be useful --- it will register the frames on the timestamp rather than the star field. </p><p>The &quot;finder&quot; threshold value, which is set automatically if left empty, can be manually set so that only the brightest pixels are used during the correlation calculation. It \'clips off\' the background, which is of little help in registering frames. Judicious use of the contrast control can give you a good way of estimating an effective number to put in this box --- slide the bottom limit up until the resulting image only contains bright pixels from stars and put that bottom value in the &quot;finder&quot; bkgnd edit box. </p><p><span style=\" font-weight:600; color:#fc0107;\">Note:</span> If there are prominent hot pixels in the image, using a hot pixel list to suppress those spurious bright pixels may also be necessary/useful.</p><p><span style=\" font-weight:600; color:#fc0107;\">General notes:</span></p><p>The edit boxes labelled \'redact top\' and \'redact bottom\' specify how many lines to remove from the top and bottom of the image to get rid of timestamp or other non-image data.</p><p>The edit box labelled \'num frames\' specifies how many frames to register and sum. For the purpose of locating a star that can produce an occultation light curve, a number of frames in the range of 100 to 400 is effective. If this number is set too high, while the target star might become visible in this enhanced image, it is likely to be lost in quantization and noise effects when frame by frame aperture photometry is attempted.</p><p><span style=\" font-weight:600; color:#fc0107;\">Note:</span> if timestamps were present (but redacted), the &quot;finder&quot; image will show the timestamp of the first frame in the stack, the so-called reference frame that all others are aligned/registered against to build the \'stack\'.</p></body></html>"))
        self.alignWithFourierCorrInfoButton.setText(_translate("MainWindow", "Align: image correlation"))
        self.alignWithTwoPointTrackInfoButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>To assist in locating a dim target star, an enhanced &quot;finder&quot; image can be generated by aligning and stacking (summing) a number of frames.</p><p>This intensified image can then be used for positioning an aperture on the target star, even though that star might be invisible in a single frame.</p><p><span style=\" font-weight:600; color:#fc0107;\">Align: 2 point track</span> requires that a 2 point tracking path be established for the video. A 2 point tracking path is a bit tedious to set up but works very well for frame alignment although it will not follow windshake. Use <span style=\" font-weight:600; color:#fc0107;\">Align: star</span> whenever there is much windshake. </p><p><span style=\" font-weight:600; color:#fc0107;\">Note:</span> The &quot;finder&quot; threshold value is not used when this alignment method is in use.</p><p><span style=\" font-weight:600; color:#fc0107;\">General notes:</span></p><p>The edit boxes labelled \'redact top\' and \'redact bottom\' specify how many lines to remove from the top and bottom of the image to get rid of timestamp or other non-image data.</p><p>The edit box labelled \'num frames\' specifies how many frames to register and sum. For the purpose of locating a star that can produce an occultation light curve, a number of frames in the range of 100 to 400 is effective. If this number is set too high, while the target star might become visible in this enhanced image, it is likely to be lost in quantization and noise effects when frame by frame aperture photometry is attempted.</p><p><span style=\" font-weight:600; color:#fc0107;\">Note:</span> if timestamps were present (but redacted), the &quot;finder&quot; image will show the timestamp of the first frame in the stack, the so-called reference frame that all others are aligned/registered against to build the \'stack\'.</p></body></html>"))
        ...
        self.finderThresholdLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p>When generating a &quot;finder&quot; image, it is often necessary to suppress the background, otherwise the images will be aligned to background features/texture rather than the star features. Ideally, the alignment works best with stars against a black background.</p><p>The value in this box sets the background threshold: all pixel values at or below this value are set to zero for the purpose of aligning images. The raw image values are then used in the stacked sum.</p><p>If you leave this box empty, a value will be estimated for you by using the Robust Mean estimator on a region in the center of the image. The threshold will be set 5 standard deviations above the mean value. But if this procedure is not effective, you can use the image contrast control to find out what setting produces stars on a black ground and place that value in this box.</p><p>You can also place an aperture somewhere with a medium bright star and click the <span style=\" font-weight:600; color:#fc0107;\">Plot Robust Mean</span> button. From that plot it is easy to estimate a threshold that will selct only star pixel values.</p></body></html>"))
        self.finderThresholdLabel.setText(_translate("MainWindow", "\"finder\" bkgnd:"))
        self.stackFramesButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>To assist in locating a dim target star, an enhanced &quot;finder&quot; image can be generated by aligning and stacking (summing) a number of frames.</p><p>This intensified image can then be used for positioning an aperture on the target star, even though that star might be invisible in a single frame.</p><p>There are three available algorithms for performing image alignment: </p><p>1) <span style=\" font-weight:600; color:#fc0107;\">Align: star</span> uses an aperture with a name that starts with \'stack\' to follow a bright star through the frames that are to be aligned --- the xy translations of that star are used subsequently to align the frames. This is the simplest and most reliable method to use and takes priority over methods 2 and 3. Click the <span style=\" font-weight:600; color:#fc0107;\">Align: star</span> button for how-to-use details.</p><p>2) <span style=\" font-weight:600; color:#fc0107;\">Align: 2 point track</span> uses a 2 point tracking path that has been established for the video. This is more tedious to set up but also works very well for frame alignment although it will not follow windshake. Use 1) whenever there is much windshake. Click the <span style=\" font-weight:600; color:#fc0107;\">Align: 2 point track</span> button for how-to-use details.</p><p>3) <span style=\" font-weight:600; color:#fc0107;\">Align: image correlation</span> aligns frames by finding the xy translation that produces the best correlation between frame n and the reference frame. Click on the <span style=\" font-weight:600; color:#fc0107;\">Align: image correlation</span> button for how-to-use details.</p><p>The &quot;finder\' image is calculated by summing the (aligned) frame stack, dividing that sum by the number of frames, and then applying the arcSinh() scaling function to give the finder image a wide dynamic range. Finally, the arcSinh() scaled image is scaled to be in the range 0...255 for display.</p><p><span style=\" font-weight:600; color:#fc0107;\">General notes:</span></p><p>The edit boxes labelled \'redact top\' and \'redact bottom\' specify how many lines to remove from the top and bottom of the image to get rid of timestamp or other non-image data.</p><p>The edit box labelled \'num frames\' specifies how many frames to register and sum. For the purpose of locating a star that can produce an occultation light curve, a number of frames in the range of 100 to 400 is effective. If this number is set too high, while the target star might become visible in this enhanced image, it is likely to be lost in quantization and noise effects when frame by frame aperture photometry is attempted.</p><p><span style=\" font-weight:600; color:#fc0107;\">Note:</span> if timestamps were present (but redacted), the &quot;finder&quot; image will show the timestamp of the first frame in the stack, the so-called reference frame that all others are aligned/registered against to build the \'stack\'.</p></body></html>"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_8), _translate("MainWindow", "Misc."))
