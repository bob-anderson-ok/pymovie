...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_11.addWidget(self.buildDarkAndNoiseFramesButton, 2, 0, 1, 1)
        ...
        self.pixelPanelInfoButton.setEnabled(False)
        self.pixelPanelInfoButton.setObjectName("pixelPanelInfoButton")
        self.verticalLayout_25.addWidget(self.pixelPanelInfoButton)
        self.plotPixelDistributionButton = QtWidgets.QPushButton(self.tab_8)
        self.plotPixelDistributionButton.setEnabled(False)
        self.plotPixelDistributionButton.setObjectName("plotPixelDistributionButton")
        self.verticalLayout_25.addWidget(self.plotPixelDistributionButton)
        self.extractBrightAndDarkPixelCoordButton = QtWidgets.QPushButton(self.tab_8)
        self.extractBrightAndDarkPixelCoordButton.setEnabled(False)
        self.extractBrightAndDarkPixelCoordButton.setObjectName("extractBrightAndDarkPixelCoordButton")
        self.verticalLayout_25.addWidget(self.extractBrightAndDarkPixelCoordButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.hotPixelErase3x3median.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-family:\'Helvetica\'; color:#000000;\">When this radio button is selected,&nbsp;a 3x3 median filter is applied to all frames as they are read.</span></p><p><span style=\" font-family:\'Helvetica\'; color:#000000;\">A median filter replaces the pixel value by the median value of all 8 surrounding pixels.</span></p><p><span style=\" font-family:\'Helvetica\'; color:#000000;\">It can be easier to use a 3x3 median filter to remove single hot-pixels -- there is no need to place apertures on hot-pixels to create a custom list.  </span></p><p><span style=\" font-family:\'Helvetica\'; color:#000000;\">The 3x3 median filter does not work as well on groups of hot pixels,&nbsp;as all the hot pixels will not be removed.  </span></p><p><span style=\" font-family:\'Helvetica\'; color:#000000;\">The 3x3 filter has a minimal (but detectable) effect on a star image that covers many dozens of pixels and so could be allowed to be active during an analysis.&nbsp;It should not be active during analysis when the star is very dim;&nbsp;the median filter may possibly reduce the intensity even more. </span></p><p><span style=\" font-family:\'Helvetica\'; color:#000000;\">If you have a hot-pixel interference problem with a lightcurve,&nbsp;try the analysis both ways:&nbsp;with and without 3x3 median filter hot-pixel removal and use the best resulting light curve.</span></p></body></html>"))
        self.hotPixelErase3x3median.setText(_translate("MainWindow", "hot-pixel removal by 3x3 median filtering"))
        self.hotPixelErase5x5median.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-family:\'Helvetica\'; color:#000000;\">When this radio button is selected,&nbsp;a 5x5 median filter is applied to all frames as they are read.</span></p><p><span style=\" font-family:\'Helvetica\'; color:#000000;\">This median filter replaces the pixel value by the median value of the surrounding 24 pixels in the 5x5 region.&nbsp;Choose to use a 5x5 median filter if your hot pixels appear in pairs or very small groups as well as singly but expect a more significant effect on star images.&nbsp;This effect is immaterial for the production of &quot;finder&quot; images (its primary intended use) but you should not allow this to be active during analysis --- it will affect the lightcurve.</span></p><p><span style=\" font-family:\'Helvetica\'; color:#000000;\">It is usually better to use a 3x3 median filter rather than a 5x5 median filter to remove single hot pixels.&nbsp;The 3x3 median filter has a minimal (but detectable) effect on a star image that covers many dozens of pixels and so could be allowed to be active during an analysis</span></p><p><span style=\" font-family:\'Helvetica\'; color:#000000;\">If you have extended clumps of hot-pixels that are not small relative to a 5x5 region,&nbsp;you will be forced to create a custom hot-pixel list generated by placing a snap-to-blob aperture on the offending groups and clicking the extract hot-pixel list button,&nbsp;adding the hot pixels to the custom list.</span></p></body></html>"))
        self.hotPixelErase5x5median.setText(_translate("MainWindow", "hot-pixel removal by 5x5 median filtering"))
...
"aperture placement."))
        ...
        self.stopFrameLabel.setToolTip(_translate("MainWindow", "stop frame"))
        self.stopFrameLabel.setText(_translate("MainWindow", "stop frame: "))
        self.startFrameLabel.setToolTip(_translate("MainWindow", "start frame"))
        self.startFrameLabel.setText(_translate("MainWindow", "start frame: "))
        self.buildDarkAndNoiseFramesButton.setToolTip(_translate("MainWindow", "Bulid frames for outlaw pixel identification"))
        self.buildDarkAndNoiseFramesButton.setText(_translate("MainWindow", "Build dark and noise frames"))
        self.activateTimestampRemovalButton.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">If there is a timestamp overlay on the video, it must be removed during the development of the </span><span style=\" font-size:18pt; font-weight:600; color:#0000ff;\">pixels-to-fix</span><span style=\" font-size:18pt;\"> table.</span></p><p><span style=\" font-size:18pt;\">Click this button to activate the spinners below and place a red horizontal line at the very top of the image and a yellow horizontal line at the very bottom.</span></p><p><span style=\" font-size:18pt;\">These lines can then be positioned most easily by hovering the mouse cursor over spinner and rolling the mouse scroll wheel.</span></p><p><span style=\" font-size:18pt;\">Alternatively, you can click the up/down buttons on the spinner or even type a number directly into the box.</span></p></body></html>"))
        self.activateTimestampRemovalButton.setText(_translate("MainWindow", "Activate timestamp removal"))
        self.upperTimestampPixelLabel.setToolTip(_translate("MainWindow", "upper timestamp limit"))
        self.upperTimestampPixelLabel.setText(_translate("MainWindow", "upper timestamp limit"))
        self.lowerTimestampPixelLabel.setToolTip(_translate("MainWindow", "lower timestamp limit"))
        self.lowerTimestampPixelLabel.setText(_translate("MainWindow", "lower timestamp limit"))
        self.pixelPanelInfoButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>Coming soon.&nbsp;This panel will allow the treatment of the thousands of hot-pixels that frequently appear in CMOS camera videos.</p><p>Fortunately these pixels nearly always appear in isolation - they are surrounded by healthy pixels that can then be used to replace the unhealthy pixel value with a reasonable and relevant value.</p><p>Such replacement can even be used during analysis (but test it) because one pixel in a star image being replaced by the average value of its neighbors will have a very small effect on the recorded intensity.</p></body></html>"))
        self.pixelPanelInfoButton.setText(_translate("MainWindow", "Click me for help/info"))
        self.plotPixelDistributionButton.setToolTip(_translate("MainWindow", "Plot pixel distribution"))
        self.plotPixelDistributionButton.setText(_translate("MainWindow", "Plot pixel distribution"))
        self.extractBrightAndDarkPixelCoordButton.setToolTip(_translate("MainWindow", "The main thing - builds pixel list"))
        self.extractBrightAndDarkPixelCoordButton.setText(_translate("MainWindow", "Find bright and dark pixels"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_8), _translate("MainWindow", "CMOS hot pixels"))
