...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.saveProfileButton = QtWidgets.QPushButton(self.widget)
        self.saveProfileButton.setObjectName("saveProfileButton")
        self.horizontalLayout_17.addWidget(self.saveProfileButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.vtiSpacerLabel.setText(_translate("MainWindow", "     "))
        self.saveProfileButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>This button is only active when an AVI-WCS folder is open. It is used in that case to save the files:</p><p><span style=\" font-weight:600; color:#fc0107;\">custom-boxes-upper.p</span></p><p><span style=\" font-weight:600; color:#fc0107;\">custom-boxes-lower.p</span></p><p><span style=\" font-weight:600; color:#fc0107;\">custom-digits.p</span></p><p><span style=\" font-weight:600; color:#fc0107;\">formatter.txt</span></p><p>to a list maintained in your user directory named pymovie-ocr-profiles-<span style=\" color:#fc0107;\">username</span>.p where <span style=\" color:#fc0107;\">username </span>would be replaced by your actual user name.</p><p>You will be prompted to give a detailed \'title\' for the profile before it is saved. This title will be displayed when you click the <span style=\" font-weight:600; color:#fc0107;\">Select custom ocr profile</span> button.</p></body></html>"))
        self.saveProfileButton.setText(_translate("MainWindow", "Save OCR profile"))
        self.lprofileButtonSpacingLabel.setText(_translate("MainWindow", "    "))
        self.loadCustomProfilesButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>This button is only active whan an AVI-WCS folder is open.</p><p>In that case, it displays the list of available custom ocr profiles (character selection box placements and model digits) retrieved by the lists found in your user home directory with the form pymovie-ocr-profiles*.p</p><p>That file pattern will retrieve your personal list of custom profiles and any others that you may have received from other users.</p><p>For most situations, it is probably better to share just the ocr profile files:</p><p><span style=\" font-weight:600; color:#fc0107;\">custom-boxes-upper.p</span></p><p><span style=\" font-weight:600; color:#fc0107;\">custom-boxes-lower.p</span></p><p><span style=\" font-weight:600; color:#fc0107;\">custom-digits.p</span></p><p><span style=\" font-weight:600; color:#fc0107;\">formatter.txt</span></p><p>Sharing just those files is all that is required. Put them in your AVI-WCS folder and then click on the<span style=\" font-weight:600; color:#fc0107;\"> Save OCR profile</span> button to save that profile with a name of your choosing in your personal list of custom ocr profiles.</p></body></html>"))
        self.loadCustomProfilesButton.setText(_translate("MainWindow", "Select custom ocr profile"))
