...
"action associated with it."))
        ...
        self.toolButton.setText(_translate("MainWindow", "Coming soon: a way to set personalized values for default\n"
"aperture size (currently 51)\n"
"and default number of sigma(std) (1, 2, or 3) (currently 2) for\n"
"mask thresholds"))
