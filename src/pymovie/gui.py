...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.saveStateButton = QtWidgets.QPushButton(self.widget)
        ...
        self.pixelHeightLabel.setMaximumSize(QtCore.QSize(85, 16777215))
        ...
        self.pixelWidthLabel.setMaximumSize(QtCore.QSize(90, 16777215))
        ...
        self.transportHelp = QtWidgets.QToolButton(self.widget1)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.transportHelp.setFont(font)
        self.transportHelp.setObjectName("transportHelp")
        self.horizontalLayout_23.addWidget(self.transportHelp)
...
"If you think that you know the plate scale more precisely than what can be calculated from two points (which might necessarily be close together due to a puacity of good stars to use for calibration), then definitely enter that value in this box."))
        ...
        self.transportHelp.setText(_translate("MainWindow", "Help"))
