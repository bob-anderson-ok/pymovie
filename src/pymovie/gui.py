...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dfDarkStdLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p>This value sets the ADU value above the median value for which a pixel is considered defective due to high dark level (hot pixel).</p><p><br/></p></body></html>"))
        self.dfDarkStdLabel.setText(_translate("MainWindow", "dark thresh"))
        ...
        self.dfGainStdLabel.setText(_translate("MainWindow", "gain thresh"))
