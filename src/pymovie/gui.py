...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.displayPlotsButton = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.cascadeCheckBox.setMinimumSize(QtCore.QSize(120, 0))
        self.cascadeCheckBox.setMaximumSize(QtCore.QSize(120, 16777215))
        ...
        self.horizontalLayout_7.addWidget(self.cascadeCheckBox)
        ...
        self.saveStateButton = QtWidgets.QPushButton(self.layoutWidget)
        self.saveStateButton.setObjectName("saveStateButton")
        self.horizontalLayout_8.addWidget(self.saveStateButton)
        self.restoreSavedStateButton = QtWidgets.QPushButton(self.layoutWidget)
        self.restoreSavedStateButton.setObjectName("restoreSavedStateButton")
        self.horizontalLayout_8.addWidget(self.restoreSavedStateButton)
        ...
        self.clearAppDataButton = QtWidgets.QPushButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.mainImageLabel = QtWidgets.QLabel(self.widget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.saveStateButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>Use this button to save a \'state\' that you want to be able to return to.</p><p>The current frame number is \'remembered\' and ...</p><p>... the set of apertures currently displayed will be \'remembered\' together wih all their propterties like position, color, etc and,<span style=\" font-weight:600; color:#fc0107;\"> take particular note</span>, the current aperture data (light curve intensities) that may be present.</p></body></html>"))
        self.saveStateButton.setText(_translate("MainWindow", "Save current frame position and aperture set/data"))
        self.restoreSavedStateButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>Return to the \'state\' present when the <span style=\" font-weight:600; color:#fc0107;\">Save current state</span> button to the left was clicked.</p></body></html>"))
        self.restoreSavedStateButton.setText(_translate("MainWindow", "Return to saved state"))
