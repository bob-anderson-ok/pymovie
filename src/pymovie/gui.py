...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.back25Button.setMaximumSize(QtCore.QSize(120, 16777215))
        ...
        self.back200Button.setMaximumSize(QtCore.QSize(120, 16777215))
        ...
        self.forward25Button.setMaximumSize(QtCore.QSize(120, 16777215))
        ...
        self.forward200Button.setMaximumSize(QtCore.QSize(120, 16777215))
        ...
        self.currentFrameLabel = QtWidgets.QLabel(self.layoutWidget)
        ...
        self.stopAtFrameLabel = QtWidgets.QLabel(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.setRadiusLabel = QtWidgets.QLabel(self.layoutWidget)
        self.setRadiusLabel.setObjectName("setRadiusLabel")
        self.horizontalLayout_8.addWidget(self.setRadiusLabel)
        ...
        self.horizontalLayout_9.addWidget(self.selectApertureSizeLabel)
...
"<pre><code>  return (np.log10(linval) - 1.0 * 0.5 * 255.0</pre></code></span><br/></p></body></html>"))
        ...
        self.back25Button.setText(_translate("MainWindow", "< 25 frames"))
        self.back200Button.setToolTip(_translate("MainWindow", "<html><head/><body><p>Jump back 200 frames.</p></body></html>"))
        self.back200Button.setText(_translate("MainWindow", "< 200 frames"))
        self.forward25Button.setToolTip(_translate("MainWindow", "<html><head/><body><p>Jump forward 25 frames.</p></body></html>"))
        self.forward25Button.setText(_translate("MainWindow", "25 frames >"))
        self.forward200Button.setToolTip(_translate("MainWindow", "<html><head/><body><p>Jump forward 200 frames.</p></body></html>"))
        self.forward200Button.setText(_translate("MainWindow", "200 frames >"))
        self.currentFrameLabel.setToolTip(_translate("MainWindow", "This box controls which frame is currently being analyzed. It can be changed by direct entry or by use of the spinner control buttons.\n"
"This will be the starting frame for an extraction triggered by clicking on the Start analysis radio button to the right."))
        self.currentFrameLabel.setText(_translate("MainWindow", " Current frame:"))
        self.stopAtFrameLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p>This box controls which frame will be the final frame in a lightcurve extraction.</p><p>At initial file read, this box will be populated with the highest available frame number.</p><p>Should you change the value in this box and wish to reset it back to the correct maximum frame number, click on the Set max stop frame button located below and to the left.</p><p><br/></p><p>Note: the value here can be less than than that in the Current frame entry. In that case, when an analysis is started, it will proceed \'backwards\' from higher numbered frames to lower numbered frames. When running \'backwards\', the analysis stops 1 frame before the Stop at frame value to make it convenient to run from both ends without duplicating the Stop at frame. </p></body></html>"))
        ...
        self.setRadiusLabel.setToolTip(_translate("MainWindow", "Sometimes the star image gets so dim (or is occulted) that the mask generation routine cannot find a connected group of 9 pixels above threshold to form a mask.\n"
"In this case, a default mask is substituted.\n"
"This spinbox (which can be edited directly) is used to set the size of this default mask.\n"
"In practice, you should set the size of the default mask to match as closely as possible the mask size of the dimmest image for which a mask was able to be computed. This will make the noise characteristics of the subtituted mask similar to \'real\' masks."))
        self.setRadiusLabel.setText(_translate("MainWindow", "Set radius (pixels) of default mask"))
        ...
        self.ucac4Label.setToolTip(_translate("MainWindow", "The entry here must be of the form XXX-XXXXX otherwise you will get a \'star not found\' message instead of the coordinates you were seeking."))
...
"If you think that you know the plate scale more precisely than what can be calculated from two points (which might necessarily be close together due to a puacity of good stars to use for calibration), then definitely enter that value in this box."))
        ...
        self.textOut.setToolTip(_translate("MainWindow", "<html><head/><body><p><br/></p></body></html>"))
