...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        spacerItem7 = QtWidgets.QSpacerItem(529, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
