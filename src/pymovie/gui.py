...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.loadCmosPixelCorrectionTableButton = QtWidgets.QPushButton(self.tab_3)
        self.loadCmosPixelCorrectionTableButton.setObjectName("loadCmosPixelCorrectionTableButton")
        self.verticalLayout_6.addWidget(self.loadCmosPixelCorrectionTableButton)
        self.enableCmosCorrectionsDuringFrameReadsCheckBox = QtWidgets.QCheckBox(self.tab_3)
        self.enableCmosCorrectionsDuringFrameReadsCheckBox.setObjectName("enableCmosCorrectionsDuringFrameReadsCheckBox")
        self.verticalLayout_6.addWidget(self.enableCmosCorrectionsDuringFrameReadsCheckBox)
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(285, 7, 462, 210))
        ...
        self.lineNoiseFilterCheckBox = QtWidgets.QCheckBox(self.layoutWidget1)
        ...
        self.horizontalRadioButton = QtWidgets.QRadioButton(self.layoutWidget1)
        ...
        self.verticalRadioButton = QtWidgets.QRadioButton(self.layoutWidget1)
        self.verticalRadioButton.setObjectName("verticalRadioButton")
        self.verticalLayout_26.addWidget(self.verticalRadioButton)
        self.bothRadioButton = QtWidgets.QRadioButton(self.layoutWidget1)
        ...
        self.upperTimestampLineLabel = QtWidgets.QLabel(self.layoutWidget1)
        ...
        self.upperTimestampMedianSpinBox = QtWidgets.QSpinBox(self.layoutWidget1)
        ...
        self.lowerTimestampLineLabel = QtWidgets.QLabel(self.layoutWidget1)
        ...
        self.lowerTimestampMedianSpinBox = QtWidgets.QSpinBox(self.layoutWidget1)
        ...
        self.showMedianProfileButton = QtWidgets.QPushButton(self.layoutWidget1)
        ...
        self.backgroundSmoothingLabel = QtWidgets.QLabel(self.layoutWidget1)
        self.backgroundSmoothingLabel.setMaximumSize(QtCore.QSize(16777215, 20))
        font = QtGui.QFont()
        font.setFamily(".SF NS Text")
        font.setPointSize(13)
        font.setBold(False)
        self.backgroundSmoothingLabel.setFont(font)
        self.backgroundSmoothingLabel.setObjectName("backgroundSmoothingLabel")
        self.horizontalLayout_34.addWidget(self.backgroundSmoothingLabel)
        self.backgroundSmoothingIntervalSpinBox = QtWidgets.QSpinBox(self.layoutWidget1)
        self.backgroundSmoothingIntervalSpinBox.setMaximumSize(QtCore.QSize(50, 16777215))
        font = QtGui.QFont()
        font.setFamily(".SF NS Text")
        font.setPointSize(13)
        font.setBold(True)
        self.backgroundSmoothingIntervalSpinBox.setFont(font)
        self.backgroundSmoothingIntervalSpinBox.setMinimum(0)
        self.backgroundSmoothingIntervalSpinBox.setMaximum(1000)
        self.backgroundSmoothingIntervalSpinBox.setProperty("value", 50)
        self.backgroundSmoothingIntervalSpinBox.setObjectName("backgroundSmoothingIntervalSpinBox")
        self.horizontalLayout_34.addWidget(self.backgroundSmoothingIntervalSpinBox)
        ...
        self.lunarCheckBox = QtWidgets.QCheckBox(self.layoutWidget1)
        ...
        self.useYellowMaskCheckBox = QtWidgets.QCheckBox(self.layoutWidget1)
        ...
        self.view3DButton = QtWidgets.QPushButton(self.layoutWidget1)
        ...
        self.allowNewVersionPopupCheckbox = QtWidgets.QCheckBox(self.layoutWidget1)
        ...
        self.verticalLayout_32.addItem(spacerItem37)
        ...
        self.gridLayout_11.addItem(spacerItem42, 6, 0, 1, 1)
        ...
        self.verticalLayout_25.addItem(spacerItem49)
        self.gridLayout_10.addLayout(self.verticalLayout_25, 0, 3, 2, 1)
        self.tabWidget.addTab(self.tab_8, "")
        self.verticalLayout_17.addWidget(self.tabWidget)
        self.layoutWidget2 = QtWidgets.QWidget(self.splitterTwo)
        self.layoutWidget2.setObjectName("layoutWidget2")
        self.verticalLayout_28 = QtWidgets.QVBoxLayout(self.layoutWidget2)
        self.verticalLayout_28.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_28.setObjectName("verticalLayout_28")
        self.frameView = ImageView(self.layoutWidget2)
        ...
        self.transportMaxLeft = QtWidgets.QToolButton(self.layoutWidget2)
        font = QtGui.QFont()
        font.setFamily(".SF NS Text")
        font.setPointSize(13)
        ...
        self.transportBigLeft = QtWidgets.QToolButton(self.layoutWidget2)
        font = QtGui.QFont()
        font.setFamily(".SF NS Text")
        font.setPointSize(13)
        ...
        self.transportSmallLeft = QtWidgets.QToolButton(self.layoutWidget2)
        font = QtGui.QFont()
        font.setFamily(".SF NS Text")
        font.setPointSize(13)
        ...
        self.transportMinusOneFrame = QtWidgets.QToolButton(self.layoutWidget2)
        font = QtGui.QFont()
        font.setFamily(".SF NS Text")
        font.setPointSize(13)
        ...
        self.transportPlayLeft = QtWidgets.QToolButton(self.layoutWidget2)
        font = QtGui.QFont()
        font.setFamily(".SF NS Text")
        font.setPointSize(13)
        ...
        self.transportPause = QtWidgets.QToolButton(self.layoutWidget2)
        ...
        self.transportAnalyze = QtWidgets.QToolButton(self.layoutWidget2)
        ...
        self.transportAnalyzeWithNRE = QtWidgets.QPushButton(self.layoutWidget2)
        self.transportAnalyzeWithNRE.setMaximumSize(QtCore.QSize(90, 16777215))
        font = QtGui.QFont()
        font.setFamily(".SF NS Text")
        font.setPointSize(13)
        font.setBold(True)
        self.transportAnalyzeWithNRE.setFont(font)
        self.transportAnalyzeWithNRE.setObjectName("transportAnalyzeWithNRE")
        self.horizontalLayout_19.addWidget(self.transportAnalyzeWithNRE)
        self.transportAnalyzeWithNPIX = QtWidgets.QPushButton(self.layoutWidget2)
        self.transportAnalyzeWithNPIX.setMaximumSize(QtCore.QSize(90, 16777215))
        font = QtGui.QFont()
        font.setFamily(".SF NS Text")
        font.setPointSize(13)
        font.setBold(True)
        self.transportAnalyzeWithNPIX.setFont(font)
        self.transportAnalyzeWithNPIX.setObjectName("transportAnalyzeWithNPIX")
        self.horizontalLayout_19.addWidget(self.transportAnalyzeWithNPIX)
        self.transportPlayRight = QtWidgets.QToolButton(self.layoutWidget2)
        font = QtGui.QFont()
        font.setFamily(".SF NS Text")
        font.setPointSize(13)
        ...
        self.transportPlusOneFrame = QtWidgets.QToolButton(self.layoutWidget2)
        font = QtGui.QFont()
        font.setFamily(".SF NS Text")
        font.setPointSize(13)
        ...
        self.transportSmallRight = QtWidgets.QToolButton(self.layoutWidget2)
        font = QtGui.QFont()
        font.setFamily(".SF NS Text")
        font.setPointSize(13)
        ...
        self.transportBigRight = QtWidgets.QToolButton(self.layoutWidget2)
        font = QtGui.QFont()
        font.setFamily(".SF NS Text")
        font.setPointSize(13)
        ...
        self.transportMaxRight = QtWidgets.QToolButton(self.layoutWidget2)
        font = QtGui.QFont()
        font.setFamily(".SF NS Text")
        font.setPointSize(13)
        ...
        self.runPyote = QtWidgets.QCheckBox(self.layoutWidget2)
        self.runPyote.setEnabled(False)
        self.runPyote.setObjectName("runPyote")
        self.horizontalLayout_20.addWidget(self.runPyote)
        ...
        self.transportCsv = QtWidgets.QToolButton(self.layoutWidget2)
        ...
        self.transportPlot = QtWidgets.QToolButton(self.layoutWidget2)
        ...
        self.transportCurrentFrameLabel = QtWidgets.QLabel(self.layoutWidget2)
        ...
        self.currentFrameSpinBox = QtWidgets.QSpinBox(self.layoutWidget2)
        ...
        self.stopAtFrameSpinBox = QtWidgets.QSpinBox(self.layoutWidget2)
        ...
        self.transportStopAtFrameLabel = QtWidgets.QLabel(self.layoutWidget2)
        ...
        self.transportMark = QtWidgets.QToolButton(self.layoutWidget2)
        font = QtGui.QFont()
        font.setFamily(".SF NS Text")
        font.setPointSize(13)
        font.setBold(True)
        ...
        self.transportReturnToMark = QtWidgets.QToolButton(self.layoutWidget2)
        ...
        self.transportClearData = QtWidgets.QToolButton(self.layoutWidget2)
        ...
        self.transportTargetPsf = QtWidgets.QPushButton(self.layoutWidget2)
        self.transportTargetPsf.setEnabled(False)
        font = QtGui.QFont()
        font.setFamily(".SF NS Text")
        font.setPointSize(13)
        font.setBold(True)
        self.transportTargetPsf.setFont(font)
        self.transportTargetPsf.setObjectName("transportTargetPsf")
        self.horizontalLayout_24.addWidget(self.transportTargetPsf)
        ...
        self.transportCalcGrowthCurveButton = QtWidgets.QPushButton(self.layoutWidget2)
        self.transportCalcGrowthCurveButton.setEnabled(False)
        font = QtGui.QFont()
        font.setFamily(".SF NS Text")
        font.setPointSize(13)
        font.setBold(True)
        self.transportCalcGrowthCurveButton.setFont(font)
        self.transportCalcGrowthCurveButton.setObjectName("transportCalcGrowthCurveButton")
        self.horizontalLayout_24.addWidget(self.transportCalcGrowthCurveButton)
        self.numPixelsToSumLabel = QtWidgets.QLabel(self.layoutWidget2)
        self.numPixelsToSumLabel.setObjectName("numPixelsToSumLabel")
        self.horizontalLayout_24.addWidget(self.numPixelsToSumLabel)
        self.numPixelsToSumSpinBox = QtWidgets.QSpinBox(self.layoutWidget2)
        self.numPixelsToSumSpinBox.setEnabled(False)
        self.numPixelsToSumSpinBox.setMaximum(999)
        self.numPixelsToSumSpinBox.setObjectName("numPixelsToSumSpinBox")
        self.horizontalLayout_24.addWidget(self.numPixelsToSumSpinBox)
        ...
        self.textOut = QtWidgets.QTextEdit(self.layoutWidget3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        ...
        self.textOutLabel = QtWidgets.QLabel(self.layoutWidget3)
        self.textOutLabel.setObjectName("textOutLabel")
        self.verticalLayout_4.addWidget(self.textOutLabel)
        self.layoutWidget4 = QtWidgets.QWidget(self.splitterOne)
        ...
        self.thumbOneView = ImageView(self.layoutWidget4)
        self.thumbOneView.setObjectName("thumbOneView")
        self.verticalLayout_2.addWidget(self.thumbOneView)
        self.thumbnailOneLabel = QtWidgets.QLabel(self.layoutWidget4)
        ...
        self.thumbTwoView = ImageView(self.layoutWidget4)
        self.thumbTwoView.setObjectName("thumbTwoView")
        self.verticalLayout.addWidget(self.thumbTwoView)
        self.thumbnailTwoLabel = QtWidgets.QLabel(self.layoutWidget4)
        ...
        MainWindow.setTabOrder(self.hotPixelEraseOff, self.hotPixelEraseFromList)
        MainWindow.setTabOrder(self.hotPixelEraseFromList, self.alignWithStarInfoButton)
        ...
        MainWindow.setTabOrder(self.stackFramesButton, self.openFinderPushButton)
        MainWindow.setTabOrder(self.openFinderPushButton, self.finderMethodEdit)
        ...
        MainWindow.setTabOrder(self.radius20radioButton, self.radius28radioButton)
        MainWindow.setTabOrder(self.radius28radioButton, self.radius32radioButton)
        ...
        MainWindow.setTabOrder(self.transportPause, self.transportAnalyze)
        MainWindow.setTabOrder(self.transportAnalyze, self.transportPlayRight)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.hotPixelEraseFromList.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-family:\'Helvetica\'; color:#000000;\">If a custom hot pixel list is created or loaded,&nbsp;checking this box will cause the removal of hot pixels during frame reading from the video using this specialized list and hot-pixel removal technique.</span></p><p><span style=\" font-family:\'Helvetica\'; color:#000000;\">Beware: there is always the possibility of generating a spurious \'dip\' in a light curve that has a hot pixel group overlapping a star image,&nbsp;particularly on a drift-through video because every pixel identified in the list has its value replaced by the procedure explained below with a value that essentially removes it from the calculation of the star intensity.</span></p><p><span style=\" font-family:\'Helvetica\'; color:#000000;\">Hot pixel removal is performed on a frame-by-frame basis by calculating an average background for that frame through a Robust Mean calculation performed on a 51 x 51 (if that was the aperture size used) pixel aperture placed at the center of the frame.&nbsp;Then, this value is used to overwrite the pixel value at each coordinate point present in the hot pixel list with the average background value.</span></p></body></html>"))
        self.hotPixelEraseFromList.setText(_translate("MainWindow", "remove hot-pixels using custom list"))
        self.loadCmosPixelCorrectionTableButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>This button opens a file selection dialog in the directory where pixel correction tables built by the CMOS pixel tool are stored. There will be found the *.p files (Python pickled object files) that have been previously saved.</p></body></html>"))
        self.loadCmosPixelCorrectionTableButton.setText(_translate("MainWindow", "Load CMOS pixel correction table"))
        self.enableCmosCorrectionsDuringFrameReadsCheckBox.setToolTip(_translate("MainWindow", "<html><head/><body><p>Check this box if you want pixel corrections from the CMOS pixel tool to be applied during light-curve extraction.</p><p>If this option is selected, it is recommended that light-curves be extracted both with and without pixel corrections to provide evidence that using pixel corrections during light-curve extraction is justified.</p></body></html>"))
        self.enableCmosCorrectionsDuringFrameReadsCheckBox.setText(_translate("MainWindow", "Enable CMOS pixel corrections during frame reads"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("MainWindow", "CCD Hot Pixels"))
...
"aperture placement."))
        ...
        self.backgroundSmoothingLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p>This value controls the \'time constant\', in readings, to be used by the background smoothing filter.</p><p>PyMovie implements a recursive filter to produce a \'smoothed\' per-pixel-background value using the following equations, which implement an \'RC filter\':</p><p><span style=\" color:#0000ff;\">(</span><span style=\" font-weight:700; color:#0000ff;\">smoothing_count </span><span style=\" color:#0000ff;\">i</span><span style=\" color:#000000;\">s the \'time constant\' of the RC filter)</span></p><p><span style=\" font-weight:700; color:#0000ff;\">b = e^(-1/smoothing_count) </span></p><p><span style=\" font-weight:700; color:#0000ff;\">a = 1.0 - b</span></p><p><span style=\" font-weight:700; color:#0000ff;\">If n=0 then avgBkgnd[n] = newBkgnd</span></p><p><span style=\" font-weight:700; color:#0000ff;\">If n &gt; 0 then avgBkgnd[n] = a * newBkgnd + b * avgBkgnd[n-1]</span></p><p>where <span style=\" font-weight:700; color:#0000ff;\">newBkgnd</span> is the background calculated for the current frame (per pixel). </p><p><span style=\" font-weight:700; color:#0000ff;\">avgBkgnd</span> is used in background-subtracted-signals to reduce the noise introduced by this needed/useful calculation. </p><p>That equation is: <span style=\" font-weight:700; color:#0000ff;\">signal = apertureSum - avgBkgnd * numPixelsInAperture</span></p><p>The default value for the window size upon startup is always 50 (not sticky between runs), but any value between 0 (no smoothing in this case) to 1000 may be used.</p><p><span style=\" color:#ff0000;\">Do not expect this to have a significant effect on aperture photometry.</span> The reason I say this is that the per-frame estimate of the per-pixel background level is based on (for the typical 51 x 51 aperture) a poisson fit to 1300 sample points from the background that have all star pixels excluded. The result is an <span style=\" font-weight:700; text-decoration: underline;\">already</span> very low noise background estimation.</p><p><span style=\" color:#ff0000;\">For NRE (Noise Reduction Extraction) such background smoothing is needed</span> because the algorithm used for noise reduction has a side effect of producing much more background noise and this smoothing mitigates that effect.</p></body></html>"))
        self.backgroundSmoothingLabel.setText(_translate("MainWindow", "bkgnd smoothing count"))
        ...
        self.allowNewVersionPopupCheckbox.setToolTip(_translate("MainWindow", "<html><head/><body><p>This splash screen can be disabled on the <span style=\" font-weight:700; color:#0000ff;\">Misc.</span> tab.</p><p><span style=\" font-weight:700; color:#ff0000;\">What\'s new with this version:</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">Centering/tracking of fixed radius masks (in static apertures) now finds the center position of the mass centroid calculated using the nThBrightPixel algorithm conceived and tested by A. G. Basden (reported in </span><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#ff0000;\">Centroids using Brightest Pixel Algorithm by A. G. Basden, et al, MNRAS, 2011</span><span style=\" font-family:\'Arial\',\'sans-serif\';\">) <br/><br/>This operates by finding the n brightest pixels in the mask, setting all other pixel values to zero, and calculating the x,y centroid of the remaining ‘mass’.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">There are three new buttons added under the image area labelled: </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#ff0000;\">AP analysis</span><span style=\" font-family:\'Arial\',\'sans-serif\';\"> (Aperture Photometry); </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#ff0000;\">NRE analysis</span><span style=\" font-family:\'Arial\',\'sans-serif\';\"> (Noise Reduction Extraction); and </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#ff0000;\">NPIX analysis</span><span style=\" font-family:\'Arial\',\'sans-serif\';\"> - replacing the single button that had previously been labeled </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#ff0000;\">Analysis</span><span style=\" font-family:\'Arial\',\'sans-serif\';\">. Aperture photometry is unchanged and works exactly as it has in the past. The new methods of extracting a light curve with lower noise is explained below. Aperture photometry with an appropriately sized fixed circular mask will usually give the best results, but determining the proper mask size to achieve the best SNR can be problematic. The NRE algorithm is very robust and will always produce acceptable results. It is a good starting point for marginal observations. Use the NPIX algorithm for low magDrop but otherwise bright occultations. Then try more standard AP techniques with both fixed and dynamic masks. As always, the final metric is SNR and the False Positive margin.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#ff0000;\">Noise Reduction Extraction has been added:</span><span style=\" font-family:\'Arial\',\'sans-serif\';\"><br/></span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-size:12pt;\"><br/></span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700;\">Background: </span><span style=\" font-family:\'Arial\',\'sans-serif\';\">Optimal extraction for imaging photometry was introduced by Tim Naylor in his 1998 paper titled: </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#ff0000;\">An optimal extraction algorithm for imaging photometry. [ Mon. Not. R. Astron. Soc. 296, 339-346 (1998)]</span><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\">.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\">Naylor\'s algorithm utilizes a two-dimensional gaussian as an approximation to the psf of stars in the image and demonstrates that this is an effective approximation in practice. Using this analytic psf, the paper describes how to calculate a weighted mask that lowers the noise in a star intensity measurement by giving a larger weight to those pixel that have a higher SNR and a lower weight to dimmer, noisier pixels - </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#000000;\">this is the core idea in all optimal extraction schemes</span><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\">.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">PyMovie uses the Naylor algorithm in the form that is optimal for sky-limited observations - i.e., dim targets - and can be used for occultations where the target completely disappears.</span></p><p><span style=\" font-weight:700; color:#ff0000;\">NPIX analysis has been added:</span></p><p>A new method of lower-noise light curve extraction has been added with the acronym NPIX.  This stands for N brightest PIXel extraction. <span style=\" font-family:\'Arial\',\'sans-serif\';\">NPIX is a naive scheme that is effective at noise reduction for a low magDrop occultation (magDrop &lt;= 2.0) that is otherwise bright - the scheme: use the sum of the n brightest pixels </span><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\">as the measured intensity.  This will be an effective idea if n is chosen small enough that sky pixels don’t get included frequently.  If n is too small, though,  star pixels will be ‘missed’ and the intensity underestimated.  If n is too large, however,  excess sky pixels will get included and the intensity will be noisier than it might otherwise be.  To aid in estimating a good value to use for n and to activate this feature, one must calculate a so-called ‘growth curve’ by clicking on the </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#ff0000;\">calculate Growth Curve</span><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\"> button. The routine will find the first local maximum of the SNR curve and put this value in the NPIX spin box. Note: because this is the first local maximum, it is possible (frequently occurs) that there is an obvious global maximum that should be used instead. Manually enter that value in the NPIX spinbox in this case</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; font-size:10pt; font-weight:700; color:#ff0000;\">Important tip:</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; font-size:10pt;\">Before doing an analysis, be sure to set the csv order in which the aperture data columns will be output to the csv file. This is easily done by clicking on the </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-size:10pt; font-weight:700; color:#0000ff;\">Examine/change aperture settings</span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-size:10pt;\"> button. In the panel that appears, the rightmost column is titled </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-size:10pt; font-weight:700; color:#0000ff;\">csv output order</span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-size:10pt;\">. Use that column to set the expected best aperture for the target to 0 - this is because when PyOTE reads this file, it will be the first lightcurve displayed. With the latest version of PyOTE, all the other data sets/lightcurves will be accessible through a drop-down list and the order of items in this list are controlled by their order in the csv file, so set the csv order to make this list order be convenient for you.</span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-size:12pt;\"><br/><br/></span></p></body></html>"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_8), _translate("MainWindow", "CMOS Pixels Tool"))
        ...
        self.transportAnalyze.setToolTip(_translate("MainWindow", "<html><head/><body><p>Extract light curves using aperture photometry.</p><p>Advance frame by frame from <span style=\" font-weight:600; color:#fc0107;\">current frame</span> up to (or down to) <span style=\" font-weight:600; color:#fc0107;\">stop frame</span>, tracking and recording aperture data for plots and csv export. That is, generate the light curve data using aperture photometry with binary masks.</p></body></html>"))
        self.transportAnalyze.setText(_translate("MainWindow", "AP analysis"))
        self.transportAnalyzeWithNRE.setToolTip(_translate("MainWindow", "<html><head/><body><p>Extract light curves using Noise Reduction Extraction.</p><p><span style=\" font-weight:700; color:#ff0000;\">You must first calculate the noise reduction psf before this function will operate.</span></p><p>Advance frame by frame from <span style=\" font-weight:600; color:#fc0107;\">current frame</span> up to (or down to) <span style=\" font-weight:600; color:#fc0107;\">stop frame</span>, tracking and recording aperture data for plots and csv export. That is, generate the light curve data using Noise Reduction Extraction based on a previously calculated Noise Reduction Extraction psf. </p><p>Weighted masks are used that give more weight to bright pixels, which have lower noise, and less weight to dimmer pixels, which are inherently noisier, resulting in an overall lower noise in the extracted light curves.</p></body></html>"))
        self.transportAnalyzeWithNRE.setText(_translate("MainWindow", "NRE analysis"))
        self.transportAnalyzeWithNPIX.setToolTip(_translate("MainWindow", "<html><head/><body><p>A new method of lower-noise light curve extraction has been added with the acronym NPIX. This stands for N brightest PIXel extraction.</p><p>NPIX is a naive scheme that is effective at noise reduction for a low magDrop occultation that of bright stars. The scheme: use the sum of the n brightest pixels <span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\">as the measured intensity. This will be an effective idea if n is chosen small enough that sky pixels don’t get included frequently. If n is too small, though, star pixels will be ‘missed’ and the intensity underestimated. If n is too large, however, excess sky pixels will get included and the intensity will be noisier than it might otherwise be. To aid in estimating a good value to use for n, one can calculate a so-called ‘growth curve’ which shows how the measured intensity and SNR changes with n. One then chooses a value for n that maximizes the SNR (usually there will be a peak value – if not, use your discretion). Use the button labelled </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#00b0f0;\">calculate Growth Curve </span><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\">to produce that \'growth\' curve.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#ff0000;\">Note:</span><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\"> This scheme will introduce some distortion for lightcurves that have a magDrop of 2 or more. Other enhanced extraction techniques should be considered for such an observation.</span></p></body></html>"))
        self.transportAnalyzeWithNPIX.setText(_translate("MainWindow", "NPIX analysis"))
        ...
        self.transportTargetPsf.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">To apply Noise Reduction Extraction in PyMovie follow these steps:</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">1) Choose a representative star that is fairly bright but not saturated and place a static mask aperture on this star.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">2) Name this aperture with a string that starts with: </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#0000ff;\">psf-star</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\">3) Set the radius of the circular mask in this aperture to a size that generously encloses the star image. 6.8 has been found to be effective.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\">4) The circular mask radius of ALL other static mask apertures must be the same as that used in </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#0000ff;\">psf-star</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\">5) Place a static mask aperture on the target star using the same circular mask radius used in step 3</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">6) Put values in the start frame and the stop frame boxes to set the number of frames to be utilized in composing the experimental psf (it doesn\'t take many - 10 is often enough). These frames should be selected in the baseline (not occulted) region.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">7) Click the </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#0000ff;\">calculate NRE psf</span><span style=\" font-family:\'Arial\',\'sans-serif\';\"> button.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">After the above steps have been performed, you can choose to perform a light curve extraction using \'Noise Reduction Extraction\' by clicking on the </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#0000ff;\">NRE analysis</span><span style=\" font-family:\'Arial\',\'sans-serif\';\"> button. There is no restriction on what frames can be utilized in that analysis run - no need to avoid the frames used in composing the psf.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\';\">If you click instead on the </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#0000ff;\">AP analysis</span><span style=\" font-family:\'Arial\',\'sans-serif\';\"> button, then light curve extraction will use normal aperture photometry, even if a Noise Reduction Extraction psf has been calculated.</span></p><p><span style=\" font-weight:700;\">============ Background =================</span></p><p>Optimal extraction for imaging photometry was introduced by Tim Naylor in his 1998 paper titled: <span style=\" font-weight:700; color:#ff0000;\">An optimal extraction algorithm for imaging photometry. [Mon. Not. R. Astron. Soc. 296, 339-346 (1998)]</span><span style=\" color:#000000;\">.</span></p><p><span style=\" color:#000000;\">Naylor\'s algorithm utilizes a two-dimensional gaussian as an approximation to the psf of stars in the image and demonstrates that this is an effective approximation in practice. Using this analytic psf, the paper describes how to calculate a weighted mask that lowers the noise in a star intensity measurement by giving a larger weight to those pixel that have a higher SNR and a lower weight to dimmer, noisier pixels - </span><span style=\" font-weight:700; color:#000000;\">this is the core idea in all optimal extraction schemes</span><span style=\" color:#000000;\">.</span></p><p>PyMovie uses the Naylor algorithm in the form that is optimal for sky-limited observations - i.e., dim targets - and can be used for occultations where the target completely disappears.</p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; font-size:12pt;\"><br/><br/></span></p></body></html>"))
        self.transportTargetPsf.setText(_translate("MainWindow", "calculate NRE psf"))
        self.transportCalcGrowthCurveButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>For a general discussion of the NPIX Analysis, right click on the NPIX Analysis button.</p><p>To perform an NPIX analysis you must first create an NPIX growth curve. To do this:</p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\">Set start and stop frame values you want used for composing a growth curve and then click the button to get the NPIX growth curves. Usually 10 to 20 frames is enough, you could try other ranges to see what the behavior is. There is an automatic </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#0000ff;\">mark</span><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\"> and </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#0000ff;\">Return to \'mark\'</span><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\"> and </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#0000ff;\">clear data</span><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\"> programmatic button push sequence to make it easy to make repeat runs.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\">A side-effect of this process is that the value of </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#000000;\">n</span><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\"> at the peak value of the SNR growth curve will be placed in the spin box to the right labelled </span><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#0000ff;\">num pixels to sum for NPIX analysis</span><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\"> and the spinner enabled.  This peak value will be shown on the growth curve plot as a vertical red line.</span></p><p><span style=\" font-family:\'Arial\',\'sans-serif\'; font-weight:700; color:#ff0000;\">Note:</span><span style=\" font-family:\'Arial\',\'sans-serif\'; color:#000000;\"> This scheme will introduce some distortion for lightcurves that have portions involving a magDrop of 2 or more. Other enhanced extraction techniques should be considered for such an observation.</span></p></body></html>"))
        self.transportCalcGrowthCurveButton.setText(_translate("MainWindow", "calculate Growth Curve"))
        self.numPixelsToSumLabel.setText(_translate("MainWindow", "num pixels to sum for NPIX analysis"))
