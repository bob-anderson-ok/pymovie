...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.jogOcrBoxesUpButton.setToolTip(_translate("MainWindow", "Jog OCR character selection boxes up one pixel."))
        self.jogOcrBoxesUpButton.setText(_translate("MainWindow", "up"))
        self.jogOcrBoxesLeftButton.setToolTip(_translate("MainWindow", "Jog OCR character selection boxes left one pixel."))
        self.jogOcrBoxesLeftButton.setText(_translate("MainWindow", "left"))
        self.jogOcrBoxesRightButton.setToolTip(_translate("MainWindow", "Jog OCR character selection boxes right one pixel."))
        self.jogOcrBoxesRightButton.setText(_translate("MainWindow", "right"))
        self.jogOcrBoxesDownButton.setToolTip(_translate("MainWindow", "Jog OCR character selection boxes down one pixel."))
