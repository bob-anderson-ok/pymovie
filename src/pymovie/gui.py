...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_26.addWidget(self.allowNewVersionPopupCheckbox)
        ...
        MainWindow.setTabOrder(self.frameView, self.runPyote)
        MainWindow.setTabOrder(self.runPyote, self.transportMaxLeft)
