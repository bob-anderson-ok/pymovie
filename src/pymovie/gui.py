...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget.setGeometry(QtCore.QRect(283, 6, 435, 211))
        ...
        self.transportAnalyzeWithOE = QtWidgets.QPushButton(self.layoutWidget1)
        ...
        self.transportClearOE = QtWidgets.QPushButton(self.layoutWidget1)
...
"aperture placement."))
        ...
        self.transportAnalyzeWithOE.setToolTip(_translate("MainWindow", "<html><head/><body><p>Extract light curves using optimal extraction.</p><p>Advance frame by frame from <span style=\" font-weight:600; color:#fc0107;\">current frame</span> up to (or down to) <span style=\" font-weight:600; color:#fc0107;\">stop frame</span>, tracking and recording aperture data for plots and csv export. That is, generate the light curve data using optimal extraction based on a previously calculated Optimal Extraction psf. </p><p>Weighted masks are used that give more weight to bright pixels, which have lower noise, and less weight to dimmer pixels, which are inherently noisier, resulting in an overall lower noise in the extracted light curves.</p></body></html>"))
