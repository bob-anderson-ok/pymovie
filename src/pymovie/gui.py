...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.enableHoverHelpCheckBox = QtWidgets.QCheckBox(self.layoutWidget)
        self.enableHoverHelpCheckBox.setMinimumSize(QtCore.QSize(40, 0))
        self.enableHoverHelpCheckBox.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.enableHoverHelpCheckBox.setObjectName("enableHoverHelpCheckBox")
        self.horizontalLayout_12.addWidget(self.enableHoverHelpCheckBox)
        ...
        self.back25Button = QtWidgets.QPushButton(self.layoutWidget)
        self.back25Button.setMaximumSize(QtCore.QSize(60, 16777215))
        self.back25Button.setObjectName("back25Button")
        self.verticalLayout_7.addWidget(self.back25Button)
        self.back200Button = QtWidgets.QPushButton(self.layoutWidget)
        self.back200Button.setMaximumSize(QtCore.QSize(60, 16777215))
        self.back200Button.setObjectName("back200Button")
        self.verticalLayout_7.addWidget(self.back200Button)
        self.horizontalLayout_6.addLayout(self.verticalLayout_7)
        self.verticalLayout_8 = QtWidgets.QVBoxLayout()
        self.verticalLayout_8.setSpacing(0)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.forward25Button = QtWidgets.QPushButton(self.layoutWidget)
        self.forward25Button.setMaximumSize(QtCore.QSize(60, 16777215))
        self.forward25Button.setObjectName("forward25Button")
        self.verticalLayout_8.addWidget(self.forward25Button)
        self.forward200Button = QtWidgets.QPushButton(self.layoutWidget)
        self.forward200Button.setMaximumSize(QtCore.QSize(60, 16777215))
        self.forward200Button.setObjectName("forward200Button")
        self.verticalLayout_8.addWidget(self.forward200Button)
        ...
        self.runRadioButton = QtWidgets.QRadioButton(self.layoutWidget)
        ...
        self.pauseRadioButton = QtWidgets.QRadioButton(self.layoutWidget)
        ...
        self.setMaxStopButton = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.defaultMaskRadiusDoubleSpinBox = QtWidgets.QDoubleSpinBox(self.layoutWidget)
        ...
        self.horizontalLayout_9.addWidget(self.roiComboBox)
        ...
        spacerItem8 = QtWidgets.QSpacerItem(529, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.enableHoverHelpCheckBox.setToolTip(_translate("MainWindow", "<html><head/><body><p>The best way to use the \'Tooltip\' system employed by this app is to position this dialog box off to one side where it won\'t be covered by the main app window once that has been made active.</p><p>This dialog box will be dynamically updated any time you hover over an item in the main app window that has \'hover help\' text associated with it.</p></body></html>"))
        self.enableHoverHelpCheckBox.setText(_translate("MainWindow", "Enable Tooltips"))
...
"<pre><code>  return (np.log10(linval) - 1.0 * 0.5 * 255.0</pre></code></span><br/></p></body></html>"))
        ...
        self.defaultMaskRadiusDoubleSpinBox.setToolTip(_translate("MainWindow", "<html><head/><body><p>Sometimes the star image gets so dim (or is occulted) that the mask generation routine cannot find a connected group of 9 pixels above threshold to form a mask.</p><p>In this case, a default mask is substituted.</p><p>This spinbox (which can be edited directly) is used to set the size of this default mask.</p><p>In practice, you should set the size of the default mask to match as closely as possible the mask size of the dimmest image for which a mask was able to be computed. This will make the noise characteristics of the subtituted mask similar to \'real\' masks.</p></body></html>"))
        self.label_2.setText(_translate("MainWindow", "Set radius (pixels) of default mask"))
        self.label_6.setText(_translate("MainWindow", "Plot symbol size:"))
        self.plotSymbolSizeSpinBox.setToolTip(_translate("MainWindow", "<html><head/><body><p>This spinner sets the size of the symbols used in the plots to show a data value position. </p><p>If you open a set of plots and would like to see smaller or larger dots, simply close the plots, change the symbol size using this spinner and reopen the plots.</p></body></html>"))
        ...
        self.label_5.setText(_translate("MainWindow", "Select aperture size"))
        ...
        self.label_8.setText(_translate("MainWindow", "UCAC4"))
        self.starIdEdit.setToolTip(_translate("MainWindow", "<html><head/><body><p>The entry here <span style=\" text-decoration: underline;\">must</span> be of the form XXX-XXXXX otherwise you will get a \'star not found\' message instead of the coordinates you were seeking.</p></body></html>"))
        ...
        self.redactLinesEdit.setToolTip(_translate("MainWindow", "<html><head/><body><p>This entry is used to specify how many lines from the image bottom to remove to get rid of the timestamp.</p><p>Getting rid of the timestamp is <span style=\" font-weight:600; color:#fc0107;\">essential</span> for getting a good image to image registration based on the star field movement. If the timestamp is not removed, then the stacking process will likely register on the timestamp instead.</p></body></html>"))
        self.label_11.setText(_translate("MainWindow", "redact lines"))
        self.numFramesToStackEdit.setToolTip(_translate("MainWindow", "<html><head/><body><p>This edit box specifies how many frames to register and sum. For the purpose of locating a star that can produce an occultation light curve, a number of frames in the range of 100 to 400 is effective. If this number is set too high, while the target star might become visible in this enhanced image, it is likely to be lost in quantization and noise effects when frame by frame aperture photometry is attempted.</p><p>Of course, your objective might be to get a \'pretty picture\' of the star field. If so, have at it, but be aware that stars may \'appear\' for which an occultation light curve cannot be extracted when processing is done frame by frame.</p></body></html>"))
        self.label_12.setText(_translate("MainWindow", "num frames"))
        ...
        self.plateScaleEdit.setToolTip(_translate("MainWindow", "<html><head/><body><p>This edit box allows a plate scale to be specified for a manual WCS calibration.</p><p>Normally, this box should be left <span style=\" font-weight:600; font-style:italic; color:#fc0107;\">empty</span>. The plate scale will then be calculated (and reported for your records) from the two calibration apertures specified.</p><p>If you think that you know the plate scale more precisely than what can be calculated from two points (which might necessarily be close together due to a puacity of good stars to use for calibration), then definitely enter that value in this box.</p></body></html>"))
        self.label_10.setText(_translate("MainWindow", "plate scale"))
