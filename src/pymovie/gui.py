...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.readAviFileButton.setText(_translate("MainWindow", "Open AVI/SER/ADV/AAV file"))
